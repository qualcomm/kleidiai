...
///
/// -# @ref kai_lhs_pack_f16pmrx2_f32_neon to pack the LHS matrix.
/// -# @ref kai_run_rhs_pack_nxk_qai4c32ps1s0nrx4_qau4c32s0s1_f32_f32_f32_neon or @ref
/// kai_run_rhs_pack_nxk_qai4c32ps1s0nrx4_qau4c32s1s0_f32_f32_f32_neon pack the RHS NxK matrix.
...
size_t kai_get_dst_size_matmul_clamp_f16_f16p1vlx2_qai4c32p4vlx2_1vlx4vl_sme2_mopa(
    size_t m,   //
    size_t n);  //

/// Runs the matrix multiplication (matmul) micro-kernel followed by a clamp (min-max) operation.
///
/// LHS matrix: Packed fp16 (f16p)
