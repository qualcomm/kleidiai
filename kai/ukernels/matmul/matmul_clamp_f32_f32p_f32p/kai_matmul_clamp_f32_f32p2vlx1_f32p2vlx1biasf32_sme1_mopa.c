...
void kai_run_matmul_clamp_f32_f32p2vlx1_f32p2vlx1biasf32_sme1_mopa(
    ...
    __asm__ __volatile__(
        ...
        "tbnz x17, #0, 5f\n"
        "fmov z17.s, #1.0\n"
        "load_data_pred_index_counter_2 z10.s, z11.s, p4, p4.s, x11, x10, x28\n"  // Load bias
        "zero { za }\n"
        "addvl x28, x28, #2\n"
        ...
        "store_data_pred_index_counter_2 z4.s, z12.s, p4, p4.s, x11, x10, x26\n"
        "add x26, x26, x24\n"
        "add x12, x12, #0x4\n"
        "store_data_pred_index_counter_2 z5.s, z13.s, p4, p4.s, x11, x10, x26\n"
        "add x26, x26, x24\n"
        "store_data_pred_index_counter_2 z6.s, z14.s, p4, p4.s, x11, x10, x26\n"
        "add x26, x26, x24\n"
        "store_data_pred_index_counter_2 z7.s, z15.s, p4, p4.s, x11, x10, x26\n"
        "add x26, x26, x24\n"
        "cmp x12, x21, LSL #2\n"
        "blt 16b\n"
        ...
        "store_data_pred_index_counter_2 z0.s, z8.s, p4, p4.s, x11, x10, x26\n"
        "subs x20, x20, #0x1\n"
        "add x26, x26, x24\n"
        "beq 18f\n"
        "store_data_pred_index_counter_2 z1.s, z9.s, p4, p4.s, x11, x10, x26\n"
        "subs x20, x20, #0x1\n"
        "add x26, x26, x24\n"
        "beq 18f\n"
        "store_data_pred_index_counter_2 z2.s, z10.s, p4, p4.s, x11, x10, x26\n"
        "add x26, x26, x24\n"
        ...
        "add x12, x12, #0x4\n"
        "store_data_pred_index_counter_2 z16.s, z24.s, p4, p4.s, x11, x10, x26\n"
        "add x26, x26, x24\n"
        "store_data_pred_index_counter_2 z17.s, z25.s, p4, p4.s, x11, x10, x26\n"
        "add x26, x26, x24\n"
        "store_data_pred_index_counter_2 z18.s, z26.s, p4, p4.s, x11, x10, x26\n"
        "add x26, x26, x24\n"
        "store_data_pred_index_counter_2 z19.s, z27.s, p4, p4.s, x11, x10, x26\n"
        "add x26, x26, x24\n"
        "cmp x12, x21, LSL #2\n"
        "blt 23b\n"
        ...
        "store_data_pred_index_counter_2 z2.s, z10.s, p4, p4.s, x11, x10, x26\n"
        "add x26, x26, x24\n"
        "store_data_pred_index_counter_2 z3.s, z11.s, p4, p4.s, x11, x10, x26\n"
        "add x26, x26, x24\n"
        "cmp x12, x21, LSL #2\n"
        "blt 26b\n"
