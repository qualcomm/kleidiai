...
void kai_kernel_matmul_clamp_f32_f32p2vlx1_f32p2vlx1biasf32_sme1_mopa(KernelArgs* args);
...
static size_t kai_get_rhs_packed_stride_matmul_clamp_f32_f32p2vlx1_f32p2vlx1biasf32_sme1_mopa(size_t k) {
...
size_t kai_get_rhs_packed_offset_matmul_clamp_f32_f32p2vlx1_f32p2vlx1biasf32_sme1_mopa(size_t n_idx, size_t k) {
    ...
    const size_t block_idx = n_idx / kai_get_n_step_matmul_clamp_f32_f32p2vlx1_f32p2vlx1biasf32_sme1_mopa();
    return block_idx * kai_get_rhs_packed_stride_matmul_clamp_f32_f32p2vlx1_f32p2vlx1biasf32_sme1_mopa(k);
}
...
void kai_run_matmul_clamp_f32_f32p2vlx1_f32p2vlx1biasf32_sme1_mopa(
    ...
    kai_kernel_matmul_clamp_f32_f32p2vlx1_f32p2vlx1biasf32_sme1_mopa(&args);
}
