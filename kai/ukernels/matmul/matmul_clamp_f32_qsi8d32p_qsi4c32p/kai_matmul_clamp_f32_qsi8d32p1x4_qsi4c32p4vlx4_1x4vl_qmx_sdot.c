...
void kai_run_matmul_clamp_f32_qsi8d32p1x4_qsi4c32p4vlx4_1x4vl_qmx_sdot(
    ...
    __asm__ volatile(
        ...
        " addvl x0, x0, #4 \n"
        // Expand z12..z15: lower nibbles in upper 4 bits into z4..z7, upper nibbles in upper 4 bits in z12..z15
        "lsl z4.b, z12.b, #4 \n"         // lower nibble of z12 in upper bits (value *= 16)
        "and z12.b, z12.b, #0xf0 \n"     // upper nibble of z12 in upper bits, lower bits cleared (value *= 16)
        "lsl z5.b, z13.b, #4 \n"         // lower nibble of z13 in upper bits (value *= 16)
        "and z13.b, z13.b, #0xf0 \n"     // upper nibble of z13 in upper bits, lower bits cleared (value *= 16)
        "lsl z6.b, z14.b, #4 \n"         // lower nibble of z14 in upper bits (value *= 16)
        "and z14.b, z14.b, #0xf0 \n"     // upper nibble of z14 in upper bits, lower bits cleared (value *= 16)
        "lsl z7.b, z15.b, #4 \n"         // lower nibble of z15 in upper bits (value *= 16)
        "and z15.b, z15.b, #0xf0 \n"     // upper nibble of z15 in upper bits, lower bits cleared (value *= 16)
        // sdot accumulation: lower nibbles in upper bits (z4..z7), upper nibbles in upper bits (z12..z15)
        "sdot z16.s, z4.b, z0.b[0] \n"
        "sdot z17.s, z12.b, z0.b[0] \n"
        "sdot z18.s, z5.b, z0.b[0] \n"
        "sdot z19.s, z13.b, z0.b[0] \n"
        "sdot z16.s, z6.b, z0.b[1] \n"
        "sdot z17.s, z14.b, z0.b[1] \n"
        "sdot z18.s, z7.b, z0.b[1] \n"
        ...
        "sdot z17.s, z12.b, z0.b[2] \n"
        "sdot z18.s, z5.b, z0.b[2] \n"
        "sdot z19.s, z13.b, z0.b[2] \n"
        "sdot z16.s, z6.b, z0.b[3] \n"
        "sdot z17.s, z14.b, z0.b[3] \n"
        "sdot z18.s, z7.b, z0.b[3] \n"
        ...
        " fscale z16.s, p2/m, z16.s, z20.s \n"  // scale back by 1/16 (nibbles were shifted left by 4)
        " fscale z17.s, p2/m, z17.s, z20.s \n"
        " fscale z18.s, p2/m, z18.s, z20.s \n"
        " fscale z19.s, p2/m, z19.s, z20.s \n"
        " ld1rh z1.h, p2/z, [x3] \n"
        " add x3, x3, #2 \n"
