...
void kai_run_matmul_clamp_f32_qsi8d32p1vlx4_qsi4c32p4vlx4_1vlx4vl_qmx_mopa(
    ...
    __asm__ volatile(
        ...
        " inch x20, all \n"
        " lsl z6.b, z2.b, #4 \n"    // lower nibble of z2 in upper 4 bits (sign bit correct, value *= 16)
        " and z2.b, z2.b, #0xf0 \n" // upper nibble of z2 in upper 4 bits, lower bits cleared (value *= 16)
        " lsl z4.b, z3.b, #4 \n"    // lower nibble of z3 in upper 4 bits (sign bit correct, value *= 16)
        " and z3.b, z3.b, #0xf0 \n" // upper nibble of z3 in upper 4 bits, lower bits cleared (value *= 16)
        " smopa za0.s, p0/m, p0/m, z8.b, z6.b \n"
        " smopa za1.s, p0/m, p0/m, z8.b, z2.b \n"
        " smopa za2.s, p0/m, p0/m, z8.b, z4.b \n"
        " smopa za3.s, p0/m, p0/m, z8.b, z3.b \n"
        " subs x11, x11, #4 \n"
        ...
        " fscale z28.s, p0/m, z28.s, z20.s \n"
        " .inst 0x6594a3bd // scvtf z29.s, p0/M, z29.s \n"
        " fscale z29.s, p0/m, z29.s, z20.s \n"
        " .inst 0x6594a3de // scvtf z30.s, p0/M, z30.s \n"
        " fscale z30.s, p0/m, z30.s, z20.s \n"
        " .inst 0x6594a3ff // scvtf z31.s, p0/M, z31.s \n"
        " fscale z31.s, p0/m, z31.s, z20.s \n"
        " movprfx z8, z18 \n"
