...
#include "kai_matmul_clamp_f32_qsi8d32p1x4_qsi4c32p4x4_1x4_sve128b_dotprod.h"
...
void kai_kernel_matmul_clamp_f32_qsi8d32p1x4_qsi4c32p4x4_1x4_sve128b_dotprod(KernelArgs* args_ptr);
...
size_t kai_get_m_step_matmul_clamp_f32_qsi8d32p1x4_qsi4c32p4x4_1x4_sve128b_dotprod(void) {
    return kai_m_step;
}

size_t kai_get_n_step_matmul_clamp_f32_qsi8d32p1x4_qsi4c32p4x4_1x4_sve128b_dotprod(void) {
    return kai_n_step;
}

size_t kai_get_mr_matmul_clamp_f32_qsi8d32p1x4_qsi4c32p4x4_1x4_sve128b_dotprod(void) {
    return kai_mr;
}

size_t kai_get_nr_matmul_clamp_f32_qsi8d32p1x4_qsi4c32p4x4_1x4_sve128b_dotprod(void) {
    return kai_nr;
}

size_t kai_get_kr_matmul_clamp_f32_qsi8d32p1x4_qsi4c32p4x4_1x4_sve128b_dotprod(void) {
    return kai_kr;
}

size_t kai_get_sr_matmul_clamp_f32_qsi8d32p1x4_qsi4c32p4x4_1x4_sve128b_dotprod(void) {
    return kai_sr;
}

size_t kai_get_lhs_packed_offset_matmul_clamp_f32_qsi8d32p1x4_qsi4c32p4x4_1x4_sve128b_dotprod(
...
size_t kai_get_rhs_packed_offset_matmul_clamp_f32_qsi8d32p1x4_qsi4c32p4x4_1x4_sve128b_dotprod(
...
size_t kai_get_dst_offset_matmul_clamp_f32_qsi8d32p1x4_qsi4c32p4x4_1x4_sve128b_dotprod(
...
size_t kai_get_dst_size_matmul_clamp_f32_qsi8d32p1x4_qsi4c32p4x4_1x4_sve128b_dotprod(size_t m, size_t n) {
    return m * n * kai_num_bytes_dst_value;
}

void kai_run_matmul_clamp_f32_qsi8d32p1x4_qsi4c32p4x4_1x4_sve128b_dotprod(
    size_t m,                         //
    size_t n,                         //
    size_t k,                         //
    size_t bl,                        //
    ...
    KAI_ASSERT_MSG(
        kai_get_sve_vector_length_u8() == 16, "Currently, this kernel only supports 128 bit vector lengths.");
    KAI_ASSUME(m == 1);
    ...
    kai_kernel_matmul_clamp_f32_qsi8d32p1x4_qsi4c32p4x4_1x4_sve128b_dotprod(&args);
}
