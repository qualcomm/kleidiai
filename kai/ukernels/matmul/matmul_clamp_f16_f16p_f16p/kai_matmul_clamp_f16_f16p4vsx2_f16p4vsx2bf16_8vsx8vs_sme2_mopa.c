...
void kai_kernel_matmul_clamp_f16_f16p4vsx2_f16p4vsx2bf16_4vsx4vs_sme2_mopa(
    const struct kai_matmul_uker_args_internal* args);
void kai_kernel_matmul_clamp_f16_f16p4vsx2_f16p4vsx2bf16_4vsx8vs_sme2_mopa(
    const struct kai_matmul_uker_args_internal* args);
void kai_kernel_matmul_clamp_f16_f16p4vsx2_f16p4vsx2bf16_4vsx16vs_sme2_mopa(
    const struct kai_matmul_uker_args_internal* args);
void kai_kernel_matmul_clamp_f16_f16p4vsx2_f16p4vsx2bf16_8vsx4vs_sme2_mopa(
    const struct kai_matmul_uker_args_internal* args);
void kai_kernel_matmul_clamp_f16_f16p4vsx2_f16p4vsx2bf16_8vsx8vs_sme2_mopa(
    const struct kai_matmul_uker_args_internal* args);
void kai_kernel_matmul_clamp_f16_f16p4vsx2_f16p4vsx2bf16_16vsx4vs_sme2_mopa(
    const struct kai_matmul_uker_args_internal* args);
...
static void run(const struct kai_matmul_uker_config* config, const struct kai_matmul_uker_args* args) {
    ...
    if (args->flags & KAI_MATMUL_UKER_FLAGS_ARGS_CLAMP) {
        ...
        clamp_min_max[0] = (float16_t)(*(const float*)args->activation.clamp.min_ptr);
        clamp_min_max[1] = (float16_t)(*(const float*)args->activation.clamp.max_ptr);
    } else {
        clamp_min_max[0] = (float16_t)-FLT_MAX;
        clamp_min_max[1] = (float16_t)FLT_MAX;
    }
    ...
    if (main_m > 0 && main_n > 0) {
        ...
        kai_kernel_matmul_clamp_f16_f16p4vsx2_f16p4vsx2bf16_8vsx8vs_sme2_mopa(&uker_args);
    }
    ...
    if (main_m > 0 && args->shape.n > main_n) {
        ...
        if (shape_m_16vs > 0) {
            ...
            kai_kernel_matmul_clamp_f16_f16p4vsx2_f16p4vsx2bf16_16vsx4vs_sme2_mopa(&uker_args);
        ...
        if (leftover_m > 0) {
            ...
            kai_kernel_matmul_clamp_f16_f16p4vsx2_f16p4vsx2bf16_8vsx4vs_sme2_mopa(&uker_args);
        }
    }
    ...
    if (args->shape.m > main_m && args->shape.n > 0) {
        ...
        if (shape_n_16vs > 0) {
            ...
            kai_kernel_matmul_clamp_f16_f16p4vsx2_f16p4vsx2bf16_4vsx16vs_sme2_mopa(&uker_args);
        ...
        if (shape_n_8vs > 0) {
            ...
            kai_kernel_matmul_clamp_f16_f16p4vsx2_f16p4vsx2bf16_4vsx8vs_sme2_mopa(&uker_args);
        ...
        if (leftover_n > 0) {
            ...
            kai_kernel_matmul_clamp_f16_f16p4vsx2_f16p4vsx2bf16_4vsx4vs_sme2_mopa(&uker_args);
        }
    }
}
