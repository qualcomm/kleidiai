...
size_t kai_get_n_step_rhs_pack_kxn_qsi4c32ps4s0nrx4_qsu4c32s1s0(size_t nr);
...
/// kai_rhs_pack_kxn_qsi4c32ps1s0nrx4_qsu4c32s1s0_neon: the int4 values are stored in a K x N
/// matrix, where N is number of columns and K is the number of rows. Two int4 values are stored
...
///
/// The PACKED output layout differs from kai_rhs_pack_kxn_qsi4c32ps1s0nrx4_qsu4c32s1s0_neon only
...
/// cross-interleave) is identical to kai_rhs_pack_kxn_qsi4c32ps1s0nrx4_qsu4c32s1s0_neon.
///
