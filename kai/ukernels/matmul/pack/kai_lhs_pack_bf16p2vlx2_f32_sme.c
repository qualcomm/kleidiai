...
void kai_kernel_lhs_pack_bf16p2vlx2_f32_sme(size_t height, size_t width, const void* in, void* out);
...
void kai_run_lhs_pack_bf16p2vlx2_f32_sme(
    ...
    for (size_t i_m = 0; i_m < m; i_m += m_step) {
        ...
        kai_kernel_lhs_pack_bf16p2vlx2_f32_sme(height, width, in, out);
    }
}
