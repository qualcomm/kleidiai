...
#include "kai_lhs_pack_bf16p2vlx2_f32_sme2.h"
...
void kai_kernel_lhs_pack_bf16p2vlx2_f32_sme2(size_t height, size_t width, const void* in, void* out);

static size_t kai_get_mr_lhs_pack_bf16p2vlx2_f32_sme2(void) {
    return MR * kai_get_sme_vector_length_u16() / KR;
}

size_t kai_get_m_step_lhs_pack_bf16p2vlx2_f32_sme2(size_t mr) {
    KAI_UNUSED(mr);
    return kai_get_mr_lhs_pack_bf16p2vlx2_f32_sme2();
}

size_t kai_get_lhs_offset_lhs_pack_bf16p2vlx2_f32_sme2(size_t m_idx, size_t lhs_stride_row) {
    KAI_ASSUME(m_idx % kai_get_mr_lhs_pack_bf16p2vlx2_f32_sme2() == 0);
...
size_t kai_get_lhs_packed_size_lhs_pack_bf16p2vlx2_f32_sme2(size_t m, size_t k, size_t mr, size_t kr, size_t sr) {
    ...
    KAI_UNUSED(kr);
    KAI_UNUSED(sr);
    return kai_roundup(m, kai_get_mr_lhs_pack_bf16p2vlx2_f32_sme2()) * kai_roundup(k, KR) * sizeof(uint16_t);
}
...
void kai_run_lhs_pack_bf16p2vlx2_f32_sme2(
    ...
    void* lhs_packed) {
    KAI_ASSUME(mr == kai_get_mr_lhs_pack_bf16p2vlx2_f32_sme2());
    KAI_ASSUME(kr == KR);
    KAI_ASSUME(sr == SR);
    KAI_ASSUME(lhs != NULL);
    ...
    const size_t m_step = kai_get_mr_lhs_pack_bf16p2vlx2_f32_sme2();
    ...
    for (size_t i_m = 0; i_m < m; i_m += m_step) {
        ...
        kai_kernel_lhs_pack_bf16p2vlx2_f32_sme2(height, width, in, out);
    }
}
