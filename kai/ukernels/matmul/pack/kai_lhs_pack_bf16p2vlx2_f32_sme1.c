...
#include "kai_lhs_pack_bf16p2vlx2_f32_sme1.h"
...
static size_t kai_get_mr_lhs_pack_bf16p2vlx2_f32_sme1(void) {
    return MR * kai_get_sme_vector_length_u16() / KR;
}

size_t kai_get_m_step_lhs_pack_bf16p2vlx2_f32_sme1(size_t mr) {
    KAI_ASSUME(mr == kai_get_mr_lhs_pack_bf16p2vlx2_f32_sme1());
    KAI_UNUSED(mr);
    return kai_get_mr_lhs_pack_bf16p2vlx2_f32_sme1();
}

size_t kai_get_lhs_offset_lhs_pack_bf16p2vlx2_f32_sme1(size_t m_idx, size_t lhs_stride_row) {
    KAI_ASSUME(m_idx % kai_get_mr_lhs_pack_bf16p2vlx2_f32_sme1() == 0);

    return m_idx * lhs_stride_row;
}

size_t kai_get_lhs_packed_offset_lhs_pack_bf16p2vlx2_f32_sme1(size_t m_idx, size_t k, size_t mr, size_t kr, size_t sr) {
    KAI_ASSUME(m_idx % kai_get_m_step_lhs_pack_bf16p2vlx2_f32_sme1(mr) == 0);
    KAI_ASSUME(mr == kai_get_mr_lhs_pack_bf16p2vlx2_f32_sme1());
    KAI_ASSUME(kr == KR);
    KAI_ASSUME(sr == SR);
...
size_t kai_get_lhs_packed_size_lhs_pack_bf16p2vlx2_f32_sme1(size_t m, size_t k, size_t mr, size_t kr, size_t sr) {
    KAI_ASSUME(mr == kai_get_mr_lhs_pack_bf16p2vlx2_f32_sme1());
    KAI_ASSUME(kr == KR);
    KAI_ASSUME(sr == SR);
    ...
    KAI_UNUSED(kr);
    KAI_UNUSED(sr);
    return kai_roundup(m, kai_get_mr_lhs_pack_bf16p2vlx2_f32_sme1()) * kai_roundup(k, KR) * sizeof(uint16_t);
}

void kai_run_lhs_pack_bf16p2vlx2_f32_sme1(
    ...
    const size_t m_step = kai_get_mr_lhs_pack_bf16p2vlx2_f32_sme1();
