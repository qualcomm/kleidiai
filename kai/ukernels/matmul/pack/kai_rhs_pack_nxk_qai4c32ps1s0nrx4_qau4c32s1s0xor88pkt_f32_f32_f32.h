...
///
/// Use this "s1s0" variant when source column c holds k=2c in its LOW nibble and k=2c+1 in its high nibble.
///
/// Three things distinguish it from @ref kai_run_rhs_pack_nxk_qai4c32ps1s0nrx4_qau4c32s1s0_f32_f32_f32_neon,
