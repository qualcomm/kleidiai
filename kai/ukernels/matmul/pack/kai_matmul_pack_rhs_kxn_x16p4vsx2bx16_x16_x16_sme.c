...
void kai_kernel_matmul_pack_rhs_kxn_x16p4vsx2bx16_x16_x16_sme(const struct uker_args_t* args);
...
static void run(
    ...
    kai_kernel_matmul_pack_rhs_kxn_x16p4vsx2bx16_x16_x16_sme(&uker_args);
}
