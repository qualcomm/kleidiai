...
/// Public API for both source encodings of the "s4s0" kxn packer.
///
...
extern void kai_run_rhs_pack_kxn_qsi4cxp8vsx4s4s0sf32bi32_qsx4cx_f32_i32_sme(
...
static struct kai_matmul_pack_rhs_uker_dim_args kai_rhs_pack_kxn_s4s0_qsx4cx_get_step(
...
static struct kai_matmul_pack_rhs_uker_rhs_stride_args kai_rhs_pack_kxn_s4s0_qsx4cx_get_rhs_stride(
...
static size_t kai_rhs_pack_kxn_s4s0_qsx4cx_get_rhs_offset(
...
static struct kai_matmul_pack_rhs_uker_rhs_packed_stride_args kai_rhs_pack_kxn_s4s0_qsx4cx_get_rhs_packed_stride(
    const struct kai_matmul_pack_rhs_uker_config* config,
...
static size_t kai_rhs_pack_kxn_s4s0_qsx4cx_get_rhs_packed_offset(
    const struct kai_matmul_pack_rhs_uker_config* config,
...
static size_t kai_rhs_pack_kxn_s4s0_qsx4cx_get_rhs_packed_size(
    const struct kai_matmul_pack_rhs_uker_config* config,
    const struct kai_matmul_pack_rhs_uker_rhs_packed_dim_args* shape,
    const struct kai_matmul_pack_rhs_uker_rhs_packed_stride_args* stride) {
    KAI_UNUSED(config);
...
static size_t kai_rhs_pack_kxn_s4s0_qsx4cx_get_bias_n_offset(
    const struct kai_matmul_pack_rhs_uker_config* config,
...
static size_t kai_rhs_pack_kxn_s4s0_qsx4cx_get_scale_n_offset(
    const struct kai_matmul_pack_rhs_uker_config* config,
...
static void run_qsi4cx(
    const struct kai_matmul_pack_rhs_uker_config* config, const struct kai_matmul_pack_rhs_uker_args* args) {
    kai_run_rhs_pack_kxn_qsi4cxp8vsx4s4s0sf32bi32_qsx4cx_f32_i32_sme(config, args, 0);
}

static void run_qsu4cx(
    const struct kai_matmul_pack_rhs_uker_config* config, const struct kai_matmul_pack_rhs_uker_args* args) {
    kai_run_rhs_pack_kxn_qsi4cxp8vsx4s4s0sf32bi32_qsx4cx_f32_i32_sme(config, args, 8);
}
...
static struct kai_matmul_pack_rhs_uker_api make_api(
    ...
    struct kai_matmul_pack_rhs_uker_api api = {
        .run = run,
        .get_step = kai_rhs_pack_kxn_s4s0_qsx4cx_get_step,
        .get_rhs_stride = kai_rhs_pack_kxn_s4s0_qsx4cx_get_rhs_stride,
        .get_rhs_offset = kai_rhs_pack_kxn_s4s0_qsx4cx_get_rhs_offset,
        .get_rhs_packed_stride = kai_rhs_pack_kxn_s4s0_qsx4cx_get_rhs_packed_stride,
        .get_rhs_packed_offset = kai_rhs_pack_kxn_s4s0_qsx4cx_get_rhs_packed_offset,
        .get_rhs_packed_size = kai_rhs_pack_kxn_s4s0_qsx4cx_get_rhs_packed_size,
        .get_bias_n_offset = kai_rhs_pack_kxn_s4s0_qsx4cx_get_bias_n_offset,
        .get_scale_n_offset = kai_rhs_pack_kxn_s4s0_qsx4cx_get_scale_n_offset,
    };
    return api;
}
