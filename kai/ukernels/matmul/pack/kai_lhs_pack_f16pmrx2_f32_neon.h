...
/// @param[in] sr Number of kr splits.
///
/// @return The offset in bytes to the data element.
...
///
///   * LHS: @ref kai_get_lhs_offset_lhs_pack_f16pmrx2_f32_neon.
///   * Packed LHS: @ref kai_get_lhs_packed_offset_lhs_pack_f16pmrx2_f32_neon.
///
/// @param[in] m Number of rows of the unpacked LHS matrix.
/// @param[in] k Common dimension between the LHS and RHS matrix.
/// @param[in] mr Block size in M dimension.
