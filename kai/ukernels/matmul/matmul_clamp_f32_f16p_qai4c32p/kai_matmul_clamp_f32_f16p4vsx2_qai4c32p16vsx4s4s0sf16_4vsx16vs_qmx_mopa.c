...
void kai_kernel_matmul_clamp_f32_f16p4vsx2_qai4c32p16vsx4s4s0sf16_4vsx16vs_qmx_mopa(
...
static void run(const struct kai_matmul_uker_config* config, const struct kai_matmul_uker_args* args) {
    ...
    struct kai_matmul_uker_args_internal uker_args = {
        ...
        .k = args->shape.k,
        .bl = bl,
        // Reserved to preserve the internal assembly ABI. S4S0 uses arithmetic decode.
        .lut = NULL,
    ...
    kai_commit_za();
    kai_kernel_matmul_clamp_f32_f16p4vsx2_qai4c32p16vsx4s4s0sf16_4vsx16vs_qmx_mopa(&uker_args);
}
