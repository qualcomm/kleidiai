...
/// @ref kai_run_matmul_clamp_f32_qsi8d32p1vlx4_qai4c32p4vlx4_1vlx4vl_sme2_mopa, it decodes the
...
/// scale by 16, so each 32-bit slot spans four K-adjacent values and SMOPA's own 4-way
/// reduction consumes it directly -- no zip1/zip2, no lsr and no runtime zero-point
/// subtraction. The same packers serve the SDOT sibling
/// @ref kai_run_matmul_clamp_f32_qsi8d32p1x4_qai4c32p4vlx4_1x4vl_qmx_dot.
///
...
size_t kai_get_dst_size_matmul_clamp_f32_qsi8d32p1vlx4_qai4c32p4vlx4_1vlx4vl_qmx_mopa(
    size_t m,   //
    size_t n);  //
...
///
/// Instruction used: qmx (smopa), zip-free decode
///
