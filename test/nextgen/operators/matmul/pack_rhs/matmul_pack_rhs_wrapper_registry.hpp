...
/// Creates a wrapper for kai_matmul_pack_rhs_nxk_qai4c32p16vsx4s4s0sf16_qai4c32k256sf16s32s0_sme micro-kernel.
[[nodiscard]] std::unique_ptr<KernelWrapper<MatShape>>
create_matmul_pack_rhs_nxk_qai4c32p16vsx4s4s0sf16_qai4c32k256sf16s32s0_sme();
...
/// Checks if the portion produces non-empty RHS packing tiles for the qai4c32p16vsx4s4s0sf16 NxK matmul operator.
[[nodiscard]] bool is_shape_suitable_rhs_qai4c32p16vsx4s4s0sf16_qai4c32k256sf16s32s0_sme(
    size_t shape_m, size_t shape_n, size_t shape_k, const MatrixPortion& portion);
