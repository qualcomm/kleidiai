...
Span<const MatMulOperator> get_available_matmul_operators() {
    static std::array<MatMulOperator, 23> operators;
    ...
    operators[9].ref_dtype = DataType::I32;
    ...
    operators[10].ref_dtype = DataType::I32;
    ...
    operators[11].ref_dtype = DataType::I32;
    ...
    operators[12].ref_dtype = DataType::I32;
    ...
    operators[19].name = "matmul_clamp_f16_f16_f16p16vsx2bf16_6x16vs_sve2p1_dot";

    operators[19].is_cpu_supported = cpu_check<cpu_has_sve2p1, cpu_has_fp16>;
    operators[19].is_shape_suitable = all_true<  //
        is_shape_suitable_lhs_direct,            //
        is_shape_suitable_rhs_kxn_x16p16vsx2bx16_x16_x16_sve>;
    operators[19].supported_bias_mode_sets = {no_bias, acc_bias_per_n};
    ...
    operators[19].lhs_dtype = DataType::FP16;
    operators[19].rhs_dtype = DataType::FP16;
    operators[19].bias_dtype = DataType::FP16;
    operators[19].acc_dtype = DataType::FP32;
    operators[19].dst_dtype = DataType::FP16;

    operators[19].pack_lhs = std::nullopt;
    operators[19].pack_rhs = create_matmul_rhs_pack_kxn_x16p16vsx2bx16_x16_x16_sve();
    operators[19].matmul = create_matmul_clamp_f16_f16_f16p16vsx2bf16_6x16vs_sve2p1_dot();
    ...
    // kai_matmul_clamp_qai8_qai8p4vsx4_qsi8cxp4vsx4bi32sf32_8vsx8vs_sme2_mopa
    operators[20].name = "matmul_clamp_qai8_qai8p4vsx4_qsi8cxp4vsx4bi32sf32_8vsx8vs_sme2_mopa";

    operators[20].is_cpu_supported = cpu_has_sme2;
    operators[20].is_shape_suitable = all_true<  //
        is_shape_suitable_lhs_x8p4vsx4_x8_sme,   //
        is_shape_suitable_rhs_kxn_qsi8cxp4vsx4bi32sf32_qsi8_i32_f32_sme>;
    operators[20].supported_bias_mode_sets = {acc_bias_per_n};
    operators[20].clamp_mode = MatMulClampMode::OPTIONAL;
    operators[20].lhs_quant = std::make_unique<AsymmLinearQuantizer>(
        DataType::I8, DataType::FP32, DataType::I32, RoundMode::TIE_AWAY, RoundMode::CURRENT, 0, 0);
    operators[20].rhs_quant =
        std::make_unique<SymmLinearQuantizer>(DataType::I8, DataType::FP32, RoundMode::CURRENT, 1, 0);
    operators[20].bias_quant =
        std::make_unique<SymmLinearQuantizer>(DataType::I32, DataType::FP32, RoundMode::CURRENT, 1, 1);
    operators[20].dst_quant = std::make_unique<AsymmLinearQuantizer>(
        DataType::I8, DataType::FP32, DataType::I32, RoundMode::TIE_AWAY, RoundMode::CURRENT, 0, 0);
    operators[20].bias_quant_info_source = MatMulBiasQuantInfoSource::STATIC_FROM_INPUT_AND_OUTPUT_QUANT;
    ...
    operators[20].dst_dtype = DataType::I8;

    operators[20].pack_lhs = create_matmul_pack_lhs_mxk_x8p4vsx4_i8_sme();
    operators[20].pack_rhs = create_matmul_pack_rhs_kxn_qsi8cxp4vsx4bi32sf32_qsi8_i32_f32_sme();
    operators[20].matmul = create_matmul_clamp_qai8_qai8p4vsx4_qsi8cxp4vsx4bi32sf32_8vsx8vs_sme2_mopa();

    // kai_matmul_clamp_f16_f16_f16p4vsx2bf16_1x32vs_sme2_dot - non-transposed RHS.
    operators[21].name = "matmul_clamp_f16_f16_f16p4vsx2bf16_1x32vs_sme2_dot";
    ...
    operators[21].supported_bias_mode_sets = {acc_bias_per_n};
    ...
    operators[21].lhs_dtype = DataType::FP16;
    operators[21].rhs_dtype = DataType::FP16;
    operators[21].bias_dtype = DataType::FP16;
    operators[21].acc_dtype = DataType::FP32;
    operators[21].dst_dtype = DataType::FP16;

    operators[21].pack_lhs = std::nullopt;
    operators[21].pack_rhs = create_matmul_pack_rhs_kxn_x16p4vsx2bx16_x16_x16_sme();
    operators[21].matmul = create_matmul_clamp_f16_f16_f16p4vsx2bf16_1x32vs_sme2_dot();

    // kai_matmul_clamp_f16_f16p4vsx2_f16p4vsx2bf16_8vsx8vs_sme2_mopa - non-transposed RHS.
    operators[22].name = "matmul_clamp_f16_f16p4vsx2_f16p4vsx2bf16_8vsx8vs_sme2_mopa";
    ...
    operators[22].lhs_dtype = DataType::FP16;
    operators[22].rhs_dtype = DataType::FP16;
    operators[22].bias_dtype = DataType::FP16;
    operators[22].acc_dtype = DataType::FP32;
    operators[22].dst_dtype = DataType::FP16;

    operators[22].pack_lhs = create_matmul_pack_lhs_mxk_x16p4vsx2_x16_sme();
    operators[22].pack_rhs = create_matmul_pack_rhs_kxn_x16p4vsx2bx16_x16_x16_sme();
    operators[22].matmul = create_matmul_clamp_f16_f16p4vsx2_f16p4vsx2bf16_8vsx8vs_sme2_mopa();
