...
class MatMulTest_f32_qsi8d32p_qai4c32p_LhsPacked
    : public ::testing::TestWithParam<MatMulTestClampPortionedParamsWithBias_WithBL> {};
class MatMulTest_f32_qsi8d32p_qai4c32p_EndToEnd
    : public ::testing::TestWithParam<MatMulTestClampPortionedParamsWithBias_WithBL> {};
GTEST_ALLOW_UNINSTANTIATED_PARAMETERIZED_TEST(MatMulTest_f32_qsi8d32p_qai4c32p_EndToEnd);

TEST_P(MatMulTest_f32_qsi8d32p_qai4c32p_LhsPacked, LhsPackedWithSameBlockdepth) {
...
TEST_P(MatMulTest_f32_qsi8d32p_qai4c32p_EndToEnd, EndToEnd) {
    const auto& [variant_index, matmul_shape, bl, portion, clamp_keep_ratio, has_bias] = GetParam();
    const auto& ukernel_variant = variants_kai_matmul_clamp_f32_qsi8d32p_qai4c32p.at(variant_index);
...
static std::vector<size_t> variant_indices_with_mr(const bool mr_is_1) {
    ...
    for (size_t variant_idx = 0; variant_idx < variants_kai_matmul_clamp_f32_qsi8d32p_qai4c32p.size(); ++variant_idx) {
        const auto& variant = variants_kai_matmul_clamp_f32_qsi8d32p_qai4c32p.at(variant_idx).ukernel;
...
INSTANTIATE_TEST_SUITE_P(
    UnsupportedCPU, MatMulTest_f32_qsi8d32p_qai4c32p_EndToEnd,
    testing::Combine(
...
INSTANTIATE_TEST_SUITE_P(
    MatMulBL32, MatMulTest_f32_qsi8d32p_qai4c32p_LhsPacked,
    testing::Combine(
...
INSTANTIATE_TEST_SUITE_P(
    MatMulBL64, MatMulTest_f32_qsi8d32p_qai4c32p_LhsPacked,
    testing::Combine(
        testing::Range<size_t>(0, variants_kai_matmul_clamp_f32_qsi8d32p_qai4c32p.size()),
...
INSTANTIATE_TEST_SUITE_P(
    MatMulBL32Mr1, MatMulTest_f32_qsi8d32p_qai4c32p_EndToEnd,
    testing::Combine(
...
INSTANTIATE_TEST_SUITE_P(
    MatMulBL32MrN, MatMulTest_f32_qsi8d32p_qai4c32p_EndToEnd,
    testing::Combine(
...
INSTANTIATE_TEST_SUITE_P(
    MatMulBL64Mr1, MatMulTest_f32_qsi8d32p_qai4c32p_EndToEnd,
    testing::Combine(
...
INSTANTIATE_TEST_SUITE_P(
    MatMulBL64MrN, MatMulTest_f32_qsi8d32p_qai4c32p_EndToEnd,
    testing::Combine(
