...
inline constexpr MatMulBlockwiseDynamicQuantInterface
    kai_matmul_clamp_f32_qsi8d32p1x4_qsi4c32p4x4_1x4_sve128b_dotprod_interface{
        .run_matmul = kai_run_matmul_clamp_f32_qsi8d32p1x4_qsi4c32p4x4_1x4_sve128b_dotprod,
    };
...
inline constexpr MatMulBlockwiseDynamicQuantInterface
    kai_matmul_clamp_f32_qsi8d32p1x4_qsi4c32p16x4_1x16_ssve512b_dotprod_interface{
        .run_matmul = kai_run_matmul_clamp_f32_qsi8d32p1x4_qsi4c32p16x4_1x16_ssve512b_dotprod,
    };
inline constexpr MatMulBlockwiseDynamicQuantInterface
...
inline const std::array matmul_benchmarks{
    ...
    RegisterBenchmark(
        ...
        test::cpu_has_i8mm),
    RegisterBenchmark(
        "kai_matmul_clamp_f32_qsi8d32p1x4_qsi4c32p4x4_1x4_sve128b_dotprod",
        kai_benchmark_matmul<MatMulBlockwiseDynamicQuantInterface>,
        kai_matmul_clamp_f32_qsi8d32p1x4_qsi4c32p4x4_1x4_sve128b_dotprod_interface, DataType::FP32, MatMulOp::GEMV,
        (test::cpu_check<test::cpu_has_sve_vl128, test::cpu_has_dotprod>)),
    RegisterBenchmark(
    ...
    RegisterBenchmark(
        "kai_matmul_clamp_f32_qsi8d32p1x4_qsi4c32p16x4_1x16_ssve512b_dotprod",
        kai_benchmark_matmul<MatMulBlockwiseDynamicQuantInterface>,
        kai_matmul_clamp_f32_qsi8d32p1x4_qsi4c32p16x4_1x16_ssve512b_dotprod_interface, DataType::FP32, MatMulOp::GEMV,
        (test::cpu_check<test::cpu_has_ssve_vl512, test::cpu_has_dotprod>)),
    RegisterBenchmark(
