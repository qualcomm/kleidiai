...
#include "kai/ukernels/matmul/matmul_clamp_f16_f16_f16p/kai_matmul_clamp_f16_f16_f16p2vlx2b_1x16vl_qmx_dot.h"
...
#include "kai/ukernels/matmul/matmul_clamp_f16_f16p_f16p/kai_matmul_clamp_f16_f16p2vlx2_f16p2vlx2_2vlx2vl_qmx_mopa.h"
...
#include "kai/ukernels/matmul/matmul_clamp_f32_f16p_qsi4c32p/kai_matmul_clamp_f32_f16p1vlx2_qsi4c32p4vlx2_1vlx4vl_qmx_mopa.h"
...
#include "kai/ukernels/matmul/matmul_clamp_f32_f32_f32p/kai_matmul_clamp_f32_f32_f32p16vlx1b_1x16vl_qmx_mla.h"
#include "kai/ukernels/matmul/matmul_clamp_f32_f32_f32p/kai_matmul_clamp_f32_f32_f32p2vlx1b_1x16vl_qmx_mla.h"
...
#include "kai/ukernels/matmul/matmul_clamp_f32_qai8dxp_qsi4cxp/kai_matmul_clamp_f32_qai8dxp1vlx8_qsi4cxp4vlx8_1vlx4vl_qmx_mopa.h"
...
#include "kai/ukernels/matmul/matmul_clamp_f32_qai8dxp_qsi4cxp/kai_matmul_clamp_f32_qai8dxp1x4_qsi4cxp4vlx4_1x4vl_qmx_sdot.h"
...
#include "kai/ukernels/matmul/matmul_clamp_f16_qsi8d32p_qai4c32p/kai_matmul_clamp_f16_qsi8d32p1vlx4_qai4c32p4vlx4_1vlx4vl_qmx_mopa.h"
...
#include "kai/ukernels/matmul/matmul_clamp_f16_qsi8d32p_qai4c32p/kai_matmul_clamp_f16_qsi8d32p1x4_qai4c32p4vlx4_1x4vl_qmx_dot.h"
...
#include "kai/ukernels/matmul/matmul_clamp_f32_qsi8d32p_qai4c32p/kai_matmul_clamp_f32_qsi8d32p1vlx4_qai4c32p4vlx4_1vlx4vl_qmx_mopa.h"
...
#include "kai/ukernels/matmul/matmul_clamp_f32_qsi8d32p_qai4c32p/kai_matmul_clamp_f32_qsi8d32p1x4_qai4c32p4vlx4_1x4vl_qmx_dot.h"
...
inline constexpr MatMulUkernelApiInterface kai_matmul_clamp_f16_f16_f16p16vsx2bf16_6x16vs_sve2p1_dot_interface{
    .get_config = [] { return kai_matmul_uker_config{}; },
    .get_api = kai_matmul_clamp_f16_f16_f16p16vsx2bf16_6x16vs_sve2p1_dot,
};

inline constexpr MatMulStridedLhsInterface kai_matmul_clamp_f16_f16_f16p2vlx2b_1x16vl_qmx_dot_interface{
    .run_matmul = kai_run_matmul_clamp_f16_f16_f16p2vlx2b_1x16vl_qmx_dot,
};

inline constexpr MatMulUkernelApiInterface kai_matmul_clamp_f16_f16_f16p4vsx2bf16_1x32vs_sme2_dot_interface{
    .get_config = [] { return kai_matmul_uker_config{}; },
    .get_api = kai_matmul_clamp_f16_f16_f16p4vsx2bf16_1x32vs_sme2_dot,
};
...
inline constexpr MatMulBaseInterface kai_matmul_clamp_f16_f16p2vlx2_f16p2vlx2_2vlx2vl_qmx_mopa_interface{
...
inline constexpr MatMulBlockwiseDynamicQuantInterface
    kai_matmul_clamp_f32_f16p1vlx2_qsi4c32p4vlx2_1vlx4vl_qmx_mopa_interface{
        .run_matmul = kai_run_matmul_clamp_f32_f16p1vlx2_qsi4c32p4vlx2_1vlx4vl_qmx_mopa,
    };

// matmul_clamp_f32_f16p_qai4c32p
inline constexpr MatMulUkernelApiInterface
    kai_matmul_clamp_f32_f16p4vsx2_qai4c32p16vsx4s1s0sf16_4vsx16vs_sme2_mopa_interface{
        .get_config = [] { return kai_matmul_uker_config{}; },
        .get_api = kai_matmul_clamp_f32_f16p4vsx2_qai4c32p16vsx4s1s0sf16_4vsx16vs_sme2_mopa,
        .flags = KAI_MATMUL_UKER_FLAGS_ARGS_CLAMP,
    };

inline constexpr MatMulUkernelApiInterface
    kai_matmul_clamp_f32_f16p4vsx2_qai4c32p16vsx4s1s0sf16_4vsx16vs_qmx_mopa_interface{
        .get_config = [] { return kai_matmul_uker_config{}; },
        .get_api = kai_matmul_clamp_f32_f16p4vsx2_qai4c32p16vsx4s1s0sf16_4vsx16vs_qmx_mopa,
        .flags = KAI_MATMUL_UKER_FLAGS_ARGS_CLAMP,
    };
...
inline constexpr MatMulStridedLhsInterface kai_matmul_clamp_f32_f32_f32p2vlx1b_1x16vl_qmx_mla_interface{
    .run_matmul = kai_run_matmul_clamp_f32_f32_f32p2vlx1b_1x16vl_qmx_mla,
};
...
inline constexpr MatMulStridedLhsInterface kai_matmul_clamp_f32_f32_f32p16vlx1b_1x16vl_qmx_mla_interface{
    .run_matmul = kai_run_matmul_clamp_f32_f32_f32p16vlx1b_1x16vl_qmx_mla,
};
...
inline constexpr MatMulUkernelApiInterface kai_matmul_clamp_f32_f32_f32p4vsx1bf32_1x32vs_sme2_mla_interface{
    .get_config = [] { return kai_matmul_uker_config{}; },
    .get_api = kai_matmul_clamp_f32_f32_f32p4vsx1bf32_1x32vs_sme2_mla,
};

inline constexpr MatMulUkernelApiInterface kai_matmul_clamp_f32_f32_f32p4vsx1bf32_1x32vs_qmx_mla_interface{
    .get_config = [] { return kai_matmul_uker_config{}; },
    .get_api = kai_matmul_clamp_f32_f32_f32p4vsx1bf32_1x32vs_qmx_mla,
};
...
inline constexpr MatMulUkernelApiInterface
    kai_matmul_clamp_f32_f32p4vsx1_f32p4vsx1b_8vsx8vs_elastic_qmx_mopa_interface{
        .get_config = [] { return kai_matmul_uker_config{}; },
        .get_api = kai_matmul_clamp_f32_f32p4vsx1_f32p4vsx1bf32_8vsx8vs_qmx_mopa,
        .flags = KAI_MATMUL_UKER_FLAGS_ARGS_CLAMP,
    };
...
inline constexpr MatMulBaseInterface kai_matmul_clamp_f32_f32p2vlx1_f32p2vlx1biasf32_qmx_mopa_interface{
    .run_matmul = kai_run_matmul_clamp_f32_f32p2vlx1_f32p2vlx1biasf32_qmx_mopa,
};
// matmul_clamp_f32_i8p_i8p
inline constexpr MatMulUkernelApiInterface
    kai_matmul_clamp_f32_u8p4vsx4_u8p4vsx4_i32_i32_f32_f32_8vsx8vs_sme2_mopa_interface{
        .get_config = [] { return kai_matmul_uker_config{}; },
        .get_api = kai_matmul_clamp_f32_u8p4vsx4_u8p4vsx4_i32_i32_f32_f32_8vsx8vs_sme2_mopa,
        .flags = KAI_MATMUL_UKER_FLAGS_ARGS_CLAMP,
        .args_flags = KAI_BENCHMARK_MATMUL_UKER_ARGS_ACC_BIAS_M | KAI_BENCHMARK_MATMUL_UKER_ARGS_ACC_BIAS_N |
            KAI_BENCHMARK_MATMUL_UKER_ARGS_SCALE_BIAS_N | KAI_BENCHMARK_MATMUL_UKER_ARGS_ACC_SCALE_GLOBAL,
        .acc_bias_elem_size = sizeof(int32_t),
        .acc_scale_elem_size = sizeof(float),
        .scale_bias_elem_size = sizeof(float),
    };

inline constexpr MatMulUkernelApiInterface
    kai_matmul_clamp_f32_u8p4vsx4_u8p4vsx4_i32_i32_f32_f32_8vsx8vs_qmx_mopa_interface{
        .get_config = [] { return kai_matmul_uker_config{}; },
        .get_api = kai_matmul_clamp_f32_u8p4vsx4_u8p4vsx4_i32_i32_f32_f32_8vsx8vs_qmx_mopa,
        .flags = KAI_MATMUL_UKER_FLAGS_ARGS_CLAMP,
        .args_flags = KAI_BENCHMARK_MATMUL_UKER_ARGS_ACC_BIAS_M | KAI_BENCHMARK_MATMUL_UKER_ARGS_ACC_BIAS_N |
            KAI_BENCHMARK_MATMUL_UKER_ARGS_SCALE_BIAS_N | KAI_BENCHMARK_MATMUL_UKER_ARGS_ACC_SCALE_GLOBAL,
        .acc_bias_elem_size = sizeof(int32_t),
...
inline constexpr MatMulBlockwiseDynamicQuantLutInterface
    kai_matmul_clamp_f32_qai8dxp1vlx4_qsu2cxp4vlx4_1vlx4vl_qmx_mopa_interface{
        .run_matmul = kai_run_matmul_clamp_f32_qai8dxp1vlx4_qsu2cxp4vlx4_1vlx4vl_qmx_mopa,
    };

inline constexpr MatMulBlockwiseDynamicQuantLutInterface
    kai_matmul_clamp_f32_qai8dxp1x4_qsu2cxp4x4bf32sf32_1x4_neon_dotprod_interface{
        .run_matmul = kai_run_matmul_clamp_f32_qai8dxp1x4_qsu2cxp4x4bf32sf32_1x4_neon_dotprod,
    };
...
inline constexpr MatMulBlockwiseDynamicQuantLutInterface
    kai_matmul_clamp_f32_qai8dxp1x4_qsu2cxp4vlx4_1x4vl_qmx_dot_interface{
        .run_matmul = kai_run_matmul_clamp_f32_qai8dxp1x4_qsu2cxp4vlx4_1x4vl_qmx_dot,
    };
...
inline constexpr MatMulBlockwiseDynamicQuantInterface
    kai_matmul_clamp_f32_qai8dxp1x4_qsi4c32p4vlx4_1x4vl_qmx_dot_interface{
        .run_matmul = kai_run_matmul_clamp_f32_qai8dxp1x4_qsi4c32p4vlx4_1x4vl_qmx_dot,
    };
...
inline constexpr MatMulBlockwiseDynamicQuantInterface
    kai_matmul_clamp_f32_qai8dxp1vlx4_qsi4c32p4vlx4_1vlx4vl_qmx_mopa_interface{
        .run_matmul = kai_run_matmul_clamp_f32_qai8dxp1vlx4_qsi4c32p4vlx4_1vlx4vl_qmx_mopa,
    };
...
inline constexpr MatMulFloatInterface kai_matmul_clamp_f32_qai8dxp1vlx8_qsi4cxp4vlx8_1vlx4vl_qmx_mopa_interface{
    .run_matmul = kai_run_matmul_clamp_f32_qai8dxp1vlx8_qsi4cxp4vlx8_1vlx4vl_qmx_mopa,
};
...
inline constexpr MatMulFloatInterface kai_matmul_clamp_f32_qai8dxp1x4_qsi4cxp4vlx4_1x4vl_qmx_sdot_interface{
    .run_matmul = kai_run_matmul_clamp_f32_qai8dxp1x4_qsi4cxp4vlx4_1x4vl_qmx_sdot,
};
...
inline constexpr MatMulFloatInterface kai_matmul_clamp_f32_qai8dxp1vlx4_qsi8cxp4vlx4_1vlx4vl_qmx_mopa_interface{
    .run_matmul = kai_run_matmul_clamp_f32_qai8dxp1vlx4_qsi8cxp4vlx4_1vlx4vl_qmx_mopa,
};
...
inline constexpr MatMulFloatInterface kai_matmul_clamp_f32_qai8dxp1x4_qsi8cxp4vlx4_1x4vl_qmx_dot_interface{
    .run_matmul = kai_run_matmul_clamp_f32_qai8dxp1x4_qsi8cxp4vlx4_1x4vl_qmx_dot,
};
...
inline constexpr MatMulBlockwiseDynamicQuantInterface
    kai_matmul_clamp_f32_qsi8d32p1vlx4_qsi4c32p4vlx4_1vlx4vl_qmx_mopa_interface{
...
inline constexpr MatMulBlockwiseDynamicQuantInterface
    kai_matmul_clamp_f32_qsi8d32p1x4_qsi4c32p4vlx4_1x4vl_sme_dot_interface{
        .run_matmul = kai_run_matmul_clamp_f32_qsi8d32p1x4_qsi4c32p4vlx4_1x4vl_sme_dot,
    };

inline constexpr MatMulBlockwiseDynamicQuantInterface
    kai_matmul_clamp_f32_qsi8d32p1x4_qsi4c32p4vlx4_1x4vl_qmx_sdot_interface{
        .run_matmul = kai_run_matmul_clamp_f32_qsi8d32p1x4_qsi4c32p4vlx4_1x4vl_qmx_sdot,
    };
...
inline constexpr MatMulBaseInterface kai_matmul_clamp_f32_bf16p2vlx2_bf16p2vlx2_2vlx2vl_sme_mopa_interface{
    .run_matmul = kai_run_matmul_clamp_f32_bf16p2vlx2_bf16p2vlx2_2vlx2vl_sme_mopa,
};

// matmul_clamp_qai8_qai8_qsi4cxp
inline constexpr MatMulUkernelApiInterface kai_matmul_clamp_qai8_qai8_qsi4cxp8vsx4sf32bi32_1x64vs_sme2_dot_interface{
    .get_config = [] { return kai_matmul_uker_config{}; },
    .get_api = kai_matmul_clamp_qai8_qai8_qsi4cxp8vsx4sf32bi32_1x64vs_sme2_dot,
    .flags = KAI_MATMUL_UKER_FLAGS_ARGS_CLAMP,
    .args_flags = KAI_BENCHMARK_MATMUL_UKER_ARGS_SCALE_BIAS_GLOBAL,
    .scale_bias_elem_size = sizeof(int32_t),
};

// QMX counterpart of the above, consuming the s4s0 packed RHS shared with the qmx_mopa GEMM kernel.
inline constexpr MatMulUkernelApiInterface kai_matmul_clamp_qai8_qai8_qsi4cxp8vsx4s4s0sf32bi32_1x8vs_qmx_dot_interface{
    .get_config = [] { return kai_matmul_uker_config{}; },
    .get_api = kai_matmul_clamp_qai8_qai8_qsi4cxp8vsx4s4s0sf32bi32_1x8vs_qmx_dot,
    .flags = KAI_MATMUL_UKER_FLAGS_ARGS_CLAMP,
    .args_flags = KAI_BENCHMARK_MATMUL_UKER_ARGS_SCALE_BIAS_GLOBAL,
    .scale_bias_elem_size = sizeof(int32_t),
};

inline constexpr MatMulBaseInterface kai_matmul_clamp_f32_bf16p2vlx2_bf16p2vlx2_2vlx2vl_qmx_mopa_interface{
    .run_matmul = kai_run_matmul_clamp_f32_bf16p2vlx2_bf16p2vlx2_2vlx2vl_qmx_mopa,
};
...
// matmul_clamp_qai8_qai8_qsu2cxp
inline constexpr MatMulUkernelApiInterface kai_matmul_clamp_qai8_qai8_qsu2cxp16vsx4sf32bi32_1x64vs_sme2_dot_interface{
    .get_config = [] { return kai_matmul_uker_config{}; },
    .get_api = kai_matmul_clamp_qai8_qai8_qsu2cxp16vsx4sf32bi32_1x64vs_sme2_dot,
    .flags = KAI_MATMUL_UKER_FLAGS_ARGS_CLAMP,
    .args_flags = KAI_BENCHMARK_MATMUL_UKER_ARGS_SCALE_BIAS_GLOBAL,
    .scale_bias_elem_size = sizeof(int32_t),
};

// matmul_clamp_qai8_qai8p_qsi4cxp
inline constexpr MatMulUkernelApiInterface
    kai_matmul_clamp_qai8_qai8p8vsx4_qsi4cxp8vsx4sf32bi32_8vsx8vs_sme2_mopa_interface{
        .get_config = [] { return kai_matmul_uker_config{}; },
        .get_api = kai_matmul_clamp_qai8_qai8p8vsx4_qsi4cxp8vsx4sf32bi32_8vsx8vs_sme2_mopa,
        .flags = KAI_MATMUL_UKER_FLAGS_ARGS_CLAMP,
        .args_flags = KAI_BENCHMARK_MATMUL_UKER_ARGS_SCALE_BIAS_GLOBAL,
        .scale_bias_elem_size = sizeof(int32_t),
    };
inline constexpr MatMulUkernelApiInterface
    kai_matmul_clamp_qai8_qai8p8vsx4_qsi4cxp8vsx4sf32bi32_8vsx8vs_qmx_mopa_interface{
        .get_config = [] { return kai_matmul_uker_config{}; },
        .get_api = kai_matmul_clamp_qai8_qai8p8vsx4_qsi4cxp8vsx4sf32bi32_8vsx8vs_qmx_mopa,
        .flags = KAI_MATMUL_UKER_FLAGS_ARGS_CLAMP,
        .args_flags = KAI_BENCHMARK_MATMUL_UKER_ARGS_SCALE_BIAS_GLOBAL,
        .scale_bias_elem_size = sizeof(int32_t),
    };
...
inline constexpr MatMulStaticQuantInterface kai_matmul_clamp_qai8_qai8p2vlx4_qsi8cxpsb2vlx4_2vlx2vl_qmx_mopa_interface{
    .run_matmul = kai_run_matmul_clamp_qai8_qai8p2vlx4_qsi8cxpsb2vlx4_2vlx2vl_qmx_mopa,
};
...
inline constexpr MatMulUkernelApiInterface
    kai_matmul_clamp_qai8_qai8p4vsx4_qsi8cxp4vsx4bi32sf32_8vsx8vs_sme2_mopa_interface{
        .get_config = [] { return kai_matmul_uker_config{}; },
        .get_api = kai_matmul_clamp_qai8_qai8p4vsx4_qsi8cxp4vsx4bi32sf32_8vsx8vs_sme2_mopa,
        .flags = KAI_MATMUL_UKER_FLAGS_ARGS_CLAMP,
        .args_flags = KAI_BENCHMARK_MATMUL_UKER_ARGS_SCALE_BIAS_GLOBAL,
        .scale_bias_elem_size = sizeof(int32_t),
    };
...
inline constexpr MatMulUkernelApiInterface
    kai_matmul_clamp_qai8_qai8p4vsx4_qsi8cxp4vsx4bi32sf32_8vsx8vs_qmx_mopa_interface{
        .get_config = [] { return kai_matmul_uker_config{}; },
        .get_api = kai_matmul_clamp_qai8_qai8p4vsx4_qsi8cxp4vsx4bi32sf32_8vsx8vs_qmx_mopa,
        .flags = KAI_MATMUL_UKER_FLAGS_ARGS_CLAMP,
        .args_flags = KAI_BENCHMARK_MATMUL_UKER_ARGS_SCALE_BIAS_GLOBAL,
        .scale_bias_elem_size = sizeof(int32_t),
    };
...
inline constexpr MatMulUkernelApiInterface
    kai_matmul_clamp_qai8_qai8p4vsx4_qsi8cxp4vsx4sf32bi32_8vsx8vs_sme2p1_mop4_mopa_interface{
        .get_config = [] { return kai_matmul_uker_config{}; },
        .get_api = kai_matmul_clamp_qai8_qai8p4vsx4_qsi8cxp4vsx4sf32bi32_8vsx8vs_sme2p1_mop4_mopa,
        .flags = KAI_MATMUL_UKER_FLAGS_ARGS_CLAMP,
        .args_flags = KAI_BENCHMARK_MATMUL_UKER_ARGS_SCALE_BIAS_GLOBAL,
        .scale_bias_elem_size = sizeof(int32_t),
    };

// matmul_clamp_qai8_qai8p_qsu2cxp
inline constexpr MatMulUkernelApiInterface
    kai_matmul_clamp_qai8_qai8p8vsx4_qsu2cxp16vsx4sf32bi32_8vsx16vs_sme2_mopa_interface{
        .get_config = [] { return kai_matmul_uker_config{}; },
        .get_api = kai_matmul_clamp_qai8_qai8p8vsx4_qsu2cxp16vsx4sf32bi32_8vsx16vs_sme2_mopa,
        .flags = KAI_MATMUL_UKER_FLAGS_ARGS_CLAMP,
        .args_flags = KAI_BENCHMARK_MATMUL_UKER_ARGS_SCALE_BIAS_GLOBAL,
        .scale_bias_elem_size = sizeof(int32_t),
    };
...
inline constexpr MatMulUkernelApiInterface kai_matmul_i32_u8p4vsx4_u8p4vsx4_i32_i32_8vsx8vs_sme2_mopa_interface{
    .get_config = [] { return kai_matmul_uker_config{}; },
    .get_api = kai_matmul_i32_u8p4vsx4_u8p4vsx4_i32_i32_8vsx8vs_sme2_mopa,
    .args_flags = KAI_BENCHMARK_MATMUL_UKER_ARGS_ACC_BIAS_M | KAI_BENCHMARK_MATMUL_UKER_ARGS_ACC_BIAS_N,
    .acc_bias_elem_size = sizeof(int32_t),
};

inline constexpr MatMulUkernelApiInterface kai_matmul_i32_u8p4vsx4_u8p4vsx4_i32_i32_8vsx8vs_qmx_mopa_interface{
    .get_config = [] { return kai_matmul_uker_config{}; },
    .get_api = kai_matmul_i32_u8p4vsx4_u8p4vsx4_i32_i32_8vsx8vs_qmx_mopa,
    .args_flags = KAI_BENCHMARK_MATMUL_UKER_ARGS_ACC_BIAS_M | KAI_BENCHMARK_MATMUL_UKER_ARGS_ACC_BIAS_N,
    .acc_bias_elem_size = sizeof(int32_t),
};
...
// matmul_clamp_f16_qai8dxp_qsi4cxp
inline constexpr MatMulBaseInterface kai_matmul_clamp_f16_qai8dxp1vlx8_qsi4cxp4vlx8_1vlx4vl_sme2_mopa_interface{
    .run_matmul = kai_run_matmul_clamp_f16_qai8dxp1vlx8_qsi4cxp4vlx8_1vlx4vl_sme2_mopa,
};

inline constexpr MatMulBaseInterface kai_matmul_clamp_f16_qai8dxp1x4_qsi4cxp4vlx4_1x4vl_sme2_sdot_interface{
    .run_matmul = kai_run_matmul_clamp_f16_qai8dxp1x4_qsi4cxp4vlx4_1x4vl_sme2_sdot,
};

inline constexpr MatMulBaseInterface kai_matmul_clamp_f16_qai8dxp1vlx8_qsi4cxp4vlx8_1vlx4vl_qmx_mopa_interface{
    .run_matmul = kai_run_matmul_clamp_f16_qai8dxp1vlx8_qsi4cxp4vlx8_1vlx4vl_qmx_mopa,
};

inline constexpr MatMulBaseInterface kai_matmul_clamp_f16_qai8dxp1x4_qsi4cxp4vlx4_1x4vl_qmx_sdot_interface{
    .run_matmul = kai_run_matmul_clamp_f16_qai8dxp1x4_qsi4cxp4vlx4_1x4vl_qmx_sdot,
};
...
inline constexpr MatMulBaseInterface kai_matmul_clamp_f16_qai8dxp1vlx4_qsi8cxp4vlx4_1vlx4vl_qmx_mopa_interface{
    .run_matmul = kai_run_matmul_clamp_f16_qai8dxp1vlx4_qsi8cxp4vlx4_1vlx4vl_qmx_mopa,
};
...
inline constexpr MatMulBaseInterface kai_matmul_clamp_f16_qai8dxp1x4_qsi8cxp4vlx4_1x4vl_qmx_dot_interface{
    .run_matmul = kai_run_matmul_clamp_f16_qai8dxp1x4_qsi8cxp4vlx4_1x4vl_qmx_dot,
};
...
inline constexpr MatMulBlockwiseDynamicQuantGenericDstInterface
    kai_matmul_clamp_f16_qsi8d32p1vlx4_qai4c32p4vlx4_1vlx4vl_qmx_mopa_interface{
        .run_matmul = kai_run_matmul_clamp_f16_qsi8d32p1vlx4_qai4c32p4vlx4_1vlx4vl_qmx_mopa,
    };
...
inline constexpr MatMulBlockwiseDynamicQuantGenericDstInterface
    kai_matmul_clamp_f16_qsi8d32p1x4_qai4c32p4vlx4_1x4vl_qmx_dot_interface{
        .run_matmul = kai_run_matmul_clamp_f16_qsi8d32p1x4_qai4c32p4vlx4_1x4vl_qmx_dot,
    };
...
inline constexpr MatMulBlockwiseDynamicQuantInterface
    kai_matmul_clamp_f32_qsi8d32p1vlx4_qai4c32p4vlx4_1vlx4vl_qmx_mopa_interface{
        .run_matmul = kai_run_matmul_clamp_f32_qsi8d32p1vlx4_qai4c32p4vlx4_1vlx4vl_qmx_mopa,
    };
...
inline constexpr MatMulBlockwiseDynamicQuantInterface
    kai_matmul_clamp_f32_qsi8d32p1x4_qai4c32p4vlx4_1x4vl_qmx_dot_interface{
        .run_matmul = kai_run_matmul_clamp_f32_qsi8d32p1x4_qai4c32p4vlx4_1x4vl_qmx_dot,
    };
...
inline constexpr MatMulUkernelApiInterface
    kai_matmul_clamp_f32_qsi8d32p1x4_qai4c32p16vsx4s1s0sf16_1x16vs_sme2_dot_interface{
        .get_config = [] { return kai_matmul_uker_config{}; },
        .get_api = kai_matmul_clamp_f32_qsi8d32p1x4_qai4c32p16vsx4s1s0sf16_1x16vs_sme2_dot,
        .flags = KAI_MATMUL_UKER_FLAGS_ARGS_CLAMP,
    };

inline constexpr MatMulUkernelApiInterface
    kai_matmul_clamp_f32_qsi8d32p1x4_qai4c32p16vsx4s1s0sf16_1x16vs_qmx_dot_interface{
        .get_config = [] { return kai_matmul_uker_config{}; },
        .get_api = kai_matmul_clamp_f32_qsi8d32p1x4_qai4c32p16vsx4s1s0sf16_1x16vs_qmx_dot,
        .flags = KAI_MATMUL_UKER_FLAGS_ARGS_CLAMP,
    };
...
inline const std::array matmul_benchmarks{
    ...
    RegisterBenchmark(
        ...
        test::cpu_has_sme2),
    RegisterBenchmark(
        "kai_matmul_clamp_f16_f16_f16p2vlx2b_1x16vl_qmx_dot", kai_benchmark_matmul<MatMulStridedLhsInterface>,
        kai_matmul_clamp_f16_f16_f16p2vlx2b_1x16vl_qmx_dot_interface, DataType::FP16, MatMulOp::GEMV,
        test::cpu_has_sme),
    RegisterBenchmark(
    ...
    RegisterBenchmark(
        ...
        test::cpu_has_fp16),
    RegisterBenchmark(
        "kai_matmul_clamp_f16_f16_f16p16vsx2bf16_6x16vs_sve2p1_dot", kai_benchmark_matmul<MatMulUkernelApiInterface>,
        kai_matmul_clamp_f16_f16_f16p16vsx2bf16_6x16vs_sve2p1_dot_interface, DataType::FP16, MatMulOp::GEMM,
        test::cpu_check<test::cpu_has_sve2p1, test::cpu_has_fp16>),
    RegisterBenchmark(
        "kai_matmul_clamp_f16_f16_f16p4vsx2bf16_1x32vs_sme2_dot", kai_benchmark_matmul<MatMulUkernelApiInterface>,
        kai_matmul_clamp_f16_f16_f16p4vsx2bf16_1x32vs_sme2_dot_interface, DataType::FP16, MatMulOp::GEMV,
        test::cpu_has_sme2),
    ...
    RegisterBenchmark(
        ...
        kai_matmul_clamp_f16_f16p4vsx2_f16p4vsx2bf16_8vsx8vs_sme2_mopa_interface, DataType::FP16, MatMulOp::GEMM,
        test::cpu_has_sme2),
    ...
    RegisterBenchmark(
        ...
        test::cpu_has_sme2),
    RegisterBenchmark(
        "kai_matmul_clamp_f32_f16p1vlx2_qsi4c32p4vlx2_1vlx4vl_qmx_mopa",
        kai_benchmark_matmul<MatMulBlockwiseDynamicQuantInterface>,
        kai_matmul_clamp_f32_f16p1vlx2_qsi4c32p4vlx2_1vlx4vl_qmx_mopa_interface, DataType::FP32, MatMulOp::GEMM,
        test::cpu_has_sme),
    RegisterBenchmark(
        "kai_matmul_clamp_f32_f16p4vsx2_qai4c32p16vsx4s1s0sf16_4vsx16vs_sme2_mopa",
        kai_benchmark_matmul<MatMulUkernelApiInterface>,
        kai_matmul_clamp_f32_f16p4vsx2_qai4c32p16vsx4s1s0sf16_4vsx16vs_sme2_mopa_interface, DataType::FP32,
        MatMulOp::GEMM, test::cpu_check<test::cpu_has_sme2, test::cpu_has_fp16>),
    RegisterBenchmark(
        "kai_matmul_clamp_f32_f16p4vsx2_qai4c32p16vsx4s1s0sf16_4vsx16vs_qmx_mopa",
        kai_benchmark_matmul<MatMulUkernelApiInterface>,
        kai_matmul_clamp_f32_f16p4vsx2_qai4c32p16vsx4s1s0sf16_4vsx16vs_qmx_mopa_interface, DataType::FP32,
        MatMulOp::GEMM, test::cpu_check<test::cpu_has_sme, test::cpu_has_fp16>),
    ...
    RegisterBenchmark(
        "kai_matmul_clamp_f32_f32_f32p2vlx1b_1x16vl_qmx_mla", kai_benchmark_matmul<MatMulStridedLhsInterface>,
        kai_matmul_clamp_f32_f32_f32p2vlx1b_1x16vl_qmx_mla_interface, DataType::FP32, MatMulOp::GEMV,
        test::cpu_has_sme),
    RegisterBenchmark(
    ...
    RegisterBenchmark(
        ...
        test::cpu_has_sme2),
    RegisterBenchmark(
        "kai_matmul_clamp_f32_f32_f32p16vlx1b_1x16vl_qmx_mla", kai_benchmark_matmul<MatMulStridedLhsInterface>,
        kai_matmul_clamp_f32_f32_f32p16vlx1b_1x16vl_qmx_mla_interface, DataType::FP32, MatMulOp::GEMV,
        test::cpu_has_sme),
    RegisterBenchmark(
    ...
    RegisterBenchmark(
        "kai_matmul_clamp_f32_f32_f32p4vsx1bf32_1x32vs_sme2_mla", kai_benchmark_matmul<MatMulUkernelApiInterface>,
        kai_matmul_clamp_f32_f32_f32p4vsx1bf32_1x32vs_sme2_mla_interface, DataType::FP32, MatMulOp::GEMV,
        test::cpu_has_sme2),
    RegisterBenchmark(
        "kai_matmul_clamp_f32_f32_f32p4vsx1bf32_1x32vs_qmx_mla", kai_benchmark_matmul<MatMulUkernelApiInterface>,
        kai_matmul_clamp_f32_f32_f32p4vsx1bf32_1x32vs_qmx_mla_interface, DataType::FP32, MatMulOp::GEMV,
        test::cpu_has_sme),
    ...
    RegisterBenchmark(
        ...
        test::cpu_has_sme2),
    RegisterBenchmark(
        "kai_matmul_clamp_f32_f32p4vsx1_f32p4vsx1b_8vsx8vs_elastic_qmx_mopa",
        kai_benchmark_matmul<MatMulUkernelApiInterface>,
        kai_matmul_clamp_f32_f32p4vsx1_f32p4vsx1b_8vsx8vs_elastic_qmx_mopa_interface, DataType::FP32, MatMulOp::GEMM,
        test::cpu_has_sme),
    RegisterBenchmark(
    ...
    RegisterBenchmark(
        ...
        test::cpu_has_sme),
    RegisterBenchmark(
        "kai_matmul_clamp_f32_f32p2vlx1_f32p2vlx1biasf32_qmx_mopa", kai_benchmark_matmul<MatMulBaseInterface>,
        kai_matmul_clamp_f32_f32p2vlx1_f32p2vlx1biasf32_qmx_mopa_interface, DataType::FP32, MatMulOp::GEMM,
        test::cpu_has_sme),
    ...
    RegisterBenchmark(
        ...
        kai_benchmark_matmul<MatMulUkernelApiInterface>,
        kai_matmul_clamp_f32_u8p4vsx4_u8p4vsx4_i32_i32_f32_f32_8vsx8vs_qmx_mopa_interface, DataType::FP32,
    ...
    RegisterBenchmark(
        ...
        kai_matmul_clamp_f32_qai8dxp1x4_qsu2cxp4x4bf32sf32_1x4_neon_dotprod_interface, DataType::FP32, MatMulOp::GEMV,
        test::cpu_has_dotprod),
    RegisterBenchmark(
        ...
        test::cpu_has_sme2),
    RegisterBenchmark(
        "kai_matmul_clamp_f32_qai8dxp1x4_qsu2cxp4vlx4_1x4vl_qmx_dot",
        kai_benchmark_matmul<MatMulBlockwiseDynamicQuantLutInterface>,
        kai_matmul_clamp_f32_qai8dxp1x4_qsu2cxp4vlx4_1x4vl_qmx_dot_interface, DataType::FP32, MatMulOp::GEMV,
        test::cpu_has_sme),
    RegisterBenchmark(
        "kai_matmul_clamp_f32_qai8dxp4x4_qsu2cxp4x4bf32sf32_8x4_neon_dotprod",
        kai_benchmark_matmul<MatMulBlockwiseDynamicQuantLutInterface>,
        kai_matmul_clamp_f32_qai8dxp4x4_qsu2cxp4x4bf32sf32_8x4_neon_dotprod_interface, DataType::FP32, MatMulOp::GEMM,
        test::cpu_has_dotprod),
    RegisterBenchmark(
        ...
        test::cpu_has_sme2),
    RegisterBenchmark(
        "kai_matmul_clamp_f32_qai8dxp1vlx4_qsu2cxp4vlx4_1vlx4vl_qmx_mopa",
        kai_benchmark_matmul<MatMulBlockwiseDynamicQuantLutInterface>,
        kai_matmul_clamp_f32_qai8dxp1vlx4_qsu2cxp4vlx4_1vlx4vl_qmx_mopa_interface, DataType::FP32, MatMulOp::GEMM,
        test::cpu_has_sme),
    ...
    RegisterBenchmark(
        ...
        test::cpu_has_sme2),
    RegisterBenchmark(
        "kai_matmul_clamp_f32_qai8dxp1x4_qsi4c32p4vlx4_1x4vl_qmx_dot",
        kai_benchmark_matmul<MatMulBlockwiseDynamicQuantInterface>,
        kai_matmul_clamp_f32_qai8dxp1x4_qsi4c32p4vlx4_1x4vl_qmx_dot_interface, DataType::FP32, MatMulOp::GEMV,
        test::cpu_has_sme),
    RegisterBenchmark(
        ...
        test::cpu_has_sme2),
    RegisterBenchmark(
        "kai_matmul_clamp_f32_qai8dxp1vlx4_qsi4c32p4vlx4_1vlx4vl_qmx_mopa",
        kai_benchmark_matmul<MatMulBlockwiseDynamicQuantInterface>,
        kai_matmul_clamp_f32_qai8dxp1vlx4_qsi4c32p4vlx4_1vlx4vl_qmx_mopa_interface, DataType::FP32, MatMulOp::GEMM,
        test::cpu_has_sme),
    ...
    RegisterBenchmark(
        ...
        test::cpu_has_sme2),
    RegisterBenchmark(
        "kai_matmul_clamp_f32_qai8dxp1vlx8_qsi4cxp4vlx8_1vlx4vl_qmx_mopa", kai_benchmark_matmul<MatMulFloatInterface>,
        kai_matmul_clamp_f32_qai8dxp1vlx8_qsi4cxp4vlx8_1vlx4vl_qmx_mopa_interface, DataType::FP32, MatMulOp::GEMM,
        test::cpu_has_sme),
    RegisterBenchmark(
    ...
    RegisterBenchmark(
        ...
        test::cpu_has_sme2),
    RegisterBenchmark(
        "kai_matmul_clamp_f32_qai8dxp1x4_qsi4cxp4vlx4_1x4vl_qmx_sdot", kai_benchmark_matmul<MatMulFloatInterface>,
        kai_matmul_clamp_f32_qai8dxp1x4_qsi4cxp4vlx4_1x4vl_qmx_sdot_interface, DataType::FP32, MatMulOp::GEMV,
        test::cpu_has_sme),
    RegisterBenchmark(
    ...
    // matmul_clamp_f32_qai8dxp_qsi8cxp
    RegisterBenchmark(
        "kai_matmul_clamp_f32_qai8dxp1vlx4_qsi8cxp4vlx4_1vlx4vl_qmx_mopa", kai_benchmark_matmul<MatMulFloatInterface>,
        kai_matmul_clamp_f32_qai8dxp1vlx4_qsi8cxp4vlx4_1vlx4vl_qmx_mopa_interface, DataType::FP32, MatMulOp::GEMM,
        test::cpu_has_sme),
    RegisterBenchmark(
    ...
    RegisterBenchmark(
        ...
        test::cpu_has_sme2),
    RegisterBenchmark(
        "kai_matmul_clamp_f32_qai8dxp1x4_qsi8cxp4vlx4_1x4vl_qmx_dot", kai_benchmark_matmul<MatMulFloatInterface>,
        kai_matmul_clamp_f32_qai8dxp1x4_qsi8cxp4vlx4_1x4vl_qmx_dot_interface, DataType::FP32, MatMulOp::GEMV,
        test::cpu_has_sme),
    RegisterBenchmark(
    ...
    RegisterBenchmark(
        ...
        test::cpu_has_sme2),
    RegisterBenchmark(
        "kai_matmul_clamp_f32_bf16p2vlx2_bf16p2vlx2_2vlx2vl_sme_mopa", kai_benchmark_matmul<MatMulBaseInterface>,
        kai_matmul_clamp_f32_bf16p2vlx2_bf16p2vlx2_2vlx2vl_sme_mopa_interface, DataType::FP32, MatMulOp::GEMM,
        test::cpu_has_sme),
    RegisterBenchmark(
        "kai_matmul_clamp_f32_bf16p2vlx2_bf16p2vlx2_2vlx2vl_qmx_mopa", kai_benchmark_matmul<MatMulBaseInterface>,
        kai_matmul_clamp_f32_bf16p2vlx2_bf16p2vlx2_2vlx2vl_qmx_mopa_interface, DataType::FP32, MatMulOp::GEMM,
        test::cpu_has_sme),
    ...
    RegisterBenchmark(
        ...
        kai_benchmark_matmul<MatMulUkernelApiInterface>,
        kai_matmul_clamp_qai8_qai8_qsi4cxp8vsx4sf32bi32_1x64vs_sme2_dot_interface, DataType::QAI8, MatMulOp::GEMV,
        test::cpu_has_sme2),
    RegisterBenchmark(
        "kai_matmul_clamp_qai8_qai8_qsi4cxp8vsx4s4s0sf32bi32_1x8vs_qmx_dot",
        kai_benchmark_matmul<MatMulUkernelApiInterface>,
        kai_matmul_clamp_qai8_qai8_qsi4cxp8vsx4s4s0sf32bi32_1x8vs_qmx_dot_interface, DataType::QAI8, MatMulOp::GEMV,
        test::cpu_has_sme),
    ...
    RegisterBenchmark(
        ...
        kai_benchmark_matmul<MatMulUkernelApiInterface>,
        kai_matmul_clamp_qai8_qai8_qsu2cxp16vsx4sf32bi32_1x64vs_sme2_dot_interface, DataType::QAI8, MatMulOp::GEMV,
        test::cpu_has_sme2),
    ...
    RegisterBenchmark(
        ...
        kai_benchmark_matmul<MatMulUkernelApiInterface>,
        kai_matmul_clamp_qai8_qai8p8vsx4_qsi4cxp8vsx4sf32bi32_8vsx8vs_sme2_mopa_interface, DataType::QAI8,
        MatMulOp::GEMM, test::cpu_has_sme2),
    RegisterBenchmark(
        "kai_matmul_clamp_qai8_qai8p8vsx4_qsi4cxp8vsx4sf32bi32_8vsx8vs_qmx_mopa",
        kai_benchmark_matmul<MatMulUkernelApiInterface>,
        kai_matmul_clamp_qai8_qai8p8vsx4_qsi4cxp8vsx4sf32bi32_8vsx8vs_qmx_mopa_interface, DataType::QAI8,
        MatMulOp::GEMM, test::cpu_has_sme),
    ...
    RegisterBenchmark(
        ...
        test::cpu_has_sme2),
    RegisterBenchmark(
        "kai_matmul_clamp_qai8_qai8p2vlx4_qsi8cxpsb2vlx4_2vlx2vl_qmx_mopa",
        kai_benchmark_matmul<MatMulStaticQuantInterface>,
        kai_matmul_clamp_qai8_qai8p2vlx4_qsi8cxpsb2vlx4_2vlx2vl_qmx_mopa_interface, DataType::QAI8, MatMulOp::GEMM,
        test::cpu_has_sme),
    RegisterBenchmark(
    ...
    RegisterBenchmark(
        ...
        kai_benchmark_matmul<MatMulUkernelApiInterface>,
        kai_matmul_clamp_qai8_qai8p4vsx4_qsi8cxp4vsx4bi32sf32_8vsx8vs_sme2_mopa_interface, DataType::QAI8,
        MatMulOp::GEMM, test::cpu_has_sme2),
    RegisterBenchmark(
        "kai_matmul_clamp_qai8_qai8p4vsx4_qsi8cxp4vsx4bi32sf32_8vsx8vs_qmx_mopa",
        kai_benchmark_matmul<MatMulUkernelApiInterface>,
        kai_matmul_clamp_qai8_qai8p4vsx4_qsi8cxp4vsx4bi32sf32_8vsx8vs_qmx_mopa_interface, DataType::QAI8,
        MatMulOp::GEMM, test::cpu_has_sme),
    RegisterBenchmark(
        "kai_matmul_clamp_qai8_qai8p4vsx4_qsi8cxp4vsx4sf32bi32_8vsx8vs_sme2p1_mop4_mopa",
        kai_benchmark_matmul<MatMulUkernelApiInterface>,
        kai_matmul_clamp_qai8_qai8p4vsx4_qsi8cxp4vsx4sf32bi32_8vsx8vs_sme2p1_mop4_mopa_interface, DataType::QAI8,
        MatMulOp::GEMM, test::cpu_has_sme_mop4),
    ...
    // matmul_clamp_f16_qai8dxp_qsi4cxp
    RegisterBenchmark(
        "kai_matmul_clamp_f16_qai8dxp1x4_qsi4cxp4vlx4_1x4vl_sme2_sdot", kai_benchmark_matmul<MatMulBaseInterface>,
        kai_matmul_clamp_f16_qai8dxp1x4_qsi4cxp4vlx4_1x4vl_sme2_sdot_interface, DataType::FP16, MatMulOp::GEMV,
        test::cpu_has_sme2),
    RegisterBenchmark(
        "kai_matmul_clamp_f16_qai8dxp1x4_qsi4cxp4vlx4_1x4vl_qmx_sdot", kai_benchmark_matmul<MatMulBaseInterface>,
        kai_matmul_clamp_f16_qai8dxp1x4_qsi4cxp4vlx4_1x4vl_qmx_sdot_interface, DataType::FP16, MatMulOp::GEMV,
        test::cpu_has_sme),
    RegisterBenchmark(
    ...
    RegisterBenchmark(
        ...
        test::cpu_has_dotprod_and_fp16),
    RegisterBenchmark(
        "kai_matmul_clamp_f16_qai8dxp1vlx8_qsi4cxp4vlx8_1vlx4vl_sme2_mopa", kai_benchmark_matmul<MatMulBaseInterface>,
        kai_matmul_clamp_f16_qai8dxp1vlx8_qsi4cxp4vlx8_1vlx4vl_sme2_mopa_interface, DataType::FP16, MatMulOp::GEMM,
        test::cpu_has_sme2),
    
    RegisterBenchmark(
        "kai_matmul_clamp_f16_qai8dxp1vlx8_qsi4cxp4vlx8_1vlx4vl_qmx_mopa", kai_benchmark_matmul<MatMulBaseInterface>,
        kai_matmul_clamp_f16_qai8dxp1vlx8_qsi4cxp4vlx8_1vlx4vl_qmx_mopa_interface, DataType::FP16, MatMulOp::GEMM,
        test::cpu_has_sme),
    ...
    RegisterBenchmark(
        ...
        test::cpu_has_sme2),
    RegisterBenchmark(
        "kai_matmul_clamp_f16_qai8dxp1vlx4_qsi8cxp4vlx4_1vlx4vl_qmx_mopa", kai_benchmark_matmul<MatMulBaseInterface>,
        kai_matmul_clamp_f16_qai8dxp1vlx4_qsi8cxp4vlx4_1vlx4vl_qmx_mopa_interface, DataType::FP16, MatMulOp::GEMM,
        test::cpu_has_sme), 
    RegisterBenchmark(
        ...
        test::cpu_has_sme2),
    RegisterBenchmark(
        "kai_matmul_clamp_f16_qai8dxp1x4_qsi8cxp4vlx4_1x4vl_qmx_dot", kai_benchmark_matmul<MatMulBaseInterface>,
        kai_matmul_clamp_f16_qai8dxp1x4_qsi8cxp4vlx4_1x4vl_qmx_dot_interface, DataType::FP16, MatMulOp::GEMV,
        test::cpu_has_sme),
    RegisterBenchmark(
    ...
    RegisterBenchmark(
        ...
        test::cpu_has_sme2),
    RegisterBenchmark(
        "kai_matmul_clamp_f16_qsi8d32p1vlx4_qai4c32p4vlx4_1vlx4vl_qmx_mopa",
        kai_benchmark_matmul<MatMulBlockwiseDynamicQuantGenericDstInterface>,
        kai_matmul_clamp_f16_qsi8d32p1vlx4_qai4c32p4vlx4_1vlx4vl_qmx_mopa_interface, DataType::FP16, MatMulOp::GEMM,
        test::cpu_has_sme),
    RegisterBenchmark(
        ...
        test::cpu_has_sme2),
    RegisterBenchmark(
        "kai_matmul_clamp_f16_qsi8d32p1x4_qai4c32p4vlx4_1x4vl_qmx_dot",
        kai_benchmark_matmul<MatMulBlockwiseDynamicQuantGenericDstInterface>,
        kai_matmul_clamp_f16_qsi8d32p1x4_qai4c32p4vlx4_1x4vl_qmx_dot_interface, DataType::FP16, MatMulOp::GEMV,
        test::cpu_has_sme),
    RegisterBenchmark(
    ...
    RegisterBenchmark(
        ...
        test::cpu_has_sme2),
    RegisterBenchmark(
        "kai_matmul_clamp_f32_qsi8d32p1vlx4_qai4c32p4vlx4_1vlx4vl_qmx_mopa",
        kai_benchmark_matmul<MatMulBlockwiseDynamicQuantInterface>,
        kai_matmul_clamp_f32_qsi8d32p1vlx4_qai4c32p4vlx4_1vlx4vl_qmx_mopa_interface, DataType::FP32, MatMulOp::GEMM,
        test::cpu_has_sme),
    RegisterBenchmark(
        ...
        test::cpu_has_sme2),
    RegisterBenchmark(
        "kai_matmul_clamp_f32_qsi8d32p1x4_qai4c32p4vlx4_1x4vl_qmx_dot",
        kai_benchmark_matmul<MatMulBlockwiseDynamicQuantInterface>,
        kai_matmul_clamp_f32_qsi8d32p1x4_qai4c32p4vlx4_1x4vl_qmx_dot_interface, DataType::FP32, MatMulOp::GEMV,
        test::cpu_has_sme),
    RegisterBenchmark(
    ...
    RegisterBenchmark(
        ...
        kai_benchmark_matmul<MatMulUkernelApiInterface>,
        kai_matmul_clamp_f32_qsi8d32p1x4_qai4c32p16vsx4s1s0sf16_1x16vs_sme2_dot_interface, DataType::FP32,
        MatMulOp::GEMV, test::cpu_has_sme2),
    RegisterBenchmark(
        "kai_matmul_clamp_f32_qsi8d32p1x4_qai4c32p16vsx4s1s0sf16_1x16vs_qmx_dot",
        kai_benchmark_matmul<MatMulUkernelApiInterface>,
        kai_matmul_clamp_f32_qsi8d32p1x4_qai4c32p16vsx4s1s0sf16_1x16vs_qmx_dot_interface, DataType::FP32,
        MatMulOp::GEMV, test::cpu_has_sme),
