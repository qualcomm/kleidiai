...
bool cpu_has_sme2_f16f16(const DepthwiseArgs &args, const void *) __attribute__ ((unused));
bool cpu_has_sme2_f16f16(const DepthwiseArgs &args, const void *)
{
  return args.cpu_info->has_sme2_f16f16();
}

bool cpu_has_sme2_b16b16(const DepthwiseArgs &args, const void *) __attribute__ ((unused));
bool cpu_has_sme2_b16b16(const DepthwiseArgs &args, const void *)
{
  return args.cpu_info->has_sme2_b16b16();
}
