...
)
{
  ...
  __asm__ __volatile__(
    ...
    "lsr x21, x21, #0x1\n"
    "sub x11, x11, x21\n"
    ".inst 0xc168cb94  // fclamp { z20.h-z23.h }, z28.h, z8.h\n"
    "4:"  // Left padding
    "subs x21, x21, #0x1\n"
    "st1h { z20.h }, p1, [x10]\n"
    ...
    "add x20, x20, %x[ld_in_row], LSL #1\n"
    "ld1h { z25.h }, p1/Z, [x20]\n"
    ".inst 0xc1361ea0  // fmla za.h[x8, 0], { z21.h-z24.h }, z6.h\n"
    ".inst 0xc1321fc0  // fmla za.h[x8, 0], { z30.h-z1.h }, z2.h\n"
    ".inst 0xc1341ec0  // fmla za.h[x8, 0], { z22.h-z25.h }, z4.h\n"
    ...
    "add x20, x20, %x[ld_in_row], LSL #1\n"
    "ld1h { z25.h }, p1/Z, [x20]\n"
    ".inst 0xc1371ea0  // fmla za.h[x8, 0], { z21.h-z24.h }, z7.h\n"
    ".inst 0xc1331fa0  // fmla za.h[x8, 0], { z29.h-z0.h }, z3.h\n"
    ".inst 0xc1351ec0  // fmla za.h[x8, 0], { z22.h-z25.h }, z5.h\n"
    ...
    ".inst 0xc13a1fa0  // fmla za.h[x8, 0], { z29.h-z0.h }, z10.h\n"
    "add x21, x13, %x[ld_in_row], LSL #1\n"
    "subs x22, x22, #0x1\n"
    ".inst 0xc1361fa1  // fmla za.h[x8, 1], { z29.h-z0.h }, z6.h\n"
    "ld1h { z29.h }, p1/Z, [x13]\n"
    "add x13, x13, %x[ld_in_col], LSL #1\n"
    "add x20, x13, %x[ld_in_row], LSL #1\n"
    ".inst 0xc13b1ec0  // fmla za.h[x8, 0], { z22.h-z25.h }, z11.h\n"
    ".inst 0xc1321ec1  // fmla za.h[x8, 1], { z22.h-z25.h }, z2.h\n"
    "ld1h { z16.h }, p1/Z, [x21]\n"
    "add x21, x21, %x[ld_in_row], LSL #1\n"
    ".inst 0xc1391fc0  // fmla za.h[x8, 0], { z30.h-z1.h }, z9.h\n"
    ".inst 0xc1341fc1  // fmla za.h[x8, 1], { z30.h-z1.h }, z4.h\n"
    "ld1h { z30.h }, p1/Z, [x21]\n"
    "add x21, x21, %x[ld_in_row], LSL #1\n"
    "ld1h { z17.h }, p1/Z, [x21]\n"
    "add x21, x21, %x[ld_in_row], LSL #1\n"
    ...
    "ld1h { z29.h }, p1/Z, [x13]\n"
    ".inst 0xc168cb98  // fclamp { z24.h-z27.h }, z28.h, z8.h\n"
    "add x13, x13, %x[ld_in_col], LSL #1\n"
    ".inst 0xc1331e00  // fmla za.h[x8, 0], { z16.h-z19.h }, z3.h\n"
    "ld1h { z22.h }, p1/Z, [x20]\n"
    "add x20, x20, %x[ld_in_row], LSL #1\n"
    "st1h { z24.h }, p1, [x10]\n"
    "add x10, x10, x28, LSL #1\n"
    ...
    "add x20, x20, %x[ld_in_row], LSL #1\n"
    "mov x12, #0x8\n"
    ".inst 0xc1361ee0  // fmla za.h[x8, 0], { z23.h-z26.h }, z6.h\n"
    "ld1h { z23.h }, p0/Z, [x20]\n"
    ".inst 0x25244500  // psel p0.b, p1.b/Z, p8.b[w12]\n"
    "add x20, x20, %x[ld_in_row], LSL #1\n"
    "ld1h { z27.h }, p0/Z, [x20]\n"
    ".inst 0xc1321e80  // fmla za.h[x8, 0], { z20.h-z23.h }, z2.h\n"
    ".inst 0xc1341f00  // fmla za.h[x8, 0], { z24.h-z27.h }, z4.h\n"
    ...
    "add x20, x20, %x[ld_in_row], LSL #1\n"
    "ld1h { z1.h }, p0/Z, [x20]\n"
    ".inst 0xc1331e80  // fmla za.h[x8, 0], { z20.h-z23.h }, z3.h\n"
    ".inst 0xc1351fc0  // fmla za.h[x8, 0], { z30.h-z1.h }, z5.h\n"
    ...
    ".inst 0x25244500  // psel p0.b, p1.b/Z, p8.b[w12]\n"
    "add x21, x21, %x[ld_in_row], LSL #1\n"
    ".inst 0xc1371e40  // fmla za.h[x8, 0], { z18.h-z21.h }, z7.h\n"
    "mov x12, #0\n"
    "ld1h { z22.h }, p0/Z, [x21]\n"
    ".inst 0x25244500  // psel p0.b, p1.b/Z, p8.b[w12]\n"
    ".inst 0xc1331fa0  // fmla za.h[x8, 0], { z29.h-z0.h }, z3.h\n"
    ...
    ".inst 0x252c4500  // psel p0.b, p1.b/Z, p8.b[w12, #1]\n"
    "add x13, x13, %x[ld_in_col], LSL #1\n"
    ".inst 0xc1351e60  // fmla za.h[x8, 0], { z19.h-z22.h }, z5.h\n"
    "ld1h { z22.h }, p0/Z, [x20]\n"
    ".inst 0x25344500  // psel p0.b, p1.b/Z, p8.b[w12, #2]\n"
    "add x20, x20, %x[ld_in_row], LSL #1\n"
    "ld1h { z30.h }, p0/Z, [x20]\n"
    ...
    ".inst 0x256c4500  // psel p0.b, p1.b/Z, p8.b[w12, #5]\n"
    "add x20, x20, %x[ld_in_row], LSL #1\n"
    ".inst 0xc168cb90  // fclamp { z16.h-z19.h }, z28.h, z8.h\n"
    "ld1h { z24.h }, p0/Z, [x20]\n"
    ".inst 0x25744500  // psel p0.b, p1.b/Z, p8.b[w12, #6]\n"
    "add x20, x20, %x[ld_in_row], LSL #1\n"
    "st1h { z16.h }, p1, [x10]\n"
    ...
    "add x20, x20, %x[ld_in_row], LSL #1\n"
    "ld1h { z1.h }, p0/Z, [x20]\n"
    ".inst 0xc1331ec0  // fmla za.h[x8, 0], { z22.h-z25.h }, z3.h\n"
    ".inst 0xc1351fc0  // fmla za.h[x8, 0], { z30.h-z1.h }, z5.h\n"
    ...
    "add x20, x20, %x[ld_in_row], LSL #1\n"
    "mov x12, #0x8\n"
    ".inst 0xc13a1ee0  // fmla za.h[x8, 0], { z23.h-z26.h }, z10.h\n"
    "ld1h { z19.h }, p0/Z, [x20]\n"
    ".inst 0x25244500  // psel p0.b, p1.b/Z, p8.b[w12]\n"
    "add x20, x20, %x[ld_in_row], LSL #1\n"
    ".inst 0xc1361ee1  // fmla za.h[x8, 1], { z23.h-z26.h }, z6.h\n"
    "ld1h { z27.h }, p0/Z, [x20]\n"
    ".inst 0xc13b1e00  // fmla za.h[x8, 0], { z16.h-z19.h }, z11.h\n"
    ".inst 0xc1321e01  // fmla za.h[x8, 1], { z16.h-z19.h }, z2.h\n"
    ".inst 0xc1391f00  // fmla za.h[x8, 0], { z24.h-z27.h }, z9.h\n"
    ".inst 0xc1341f01  // fmla za.h[x8, 1], { z24.h-z27.h }, z4.h\n"
    ".inst 0xc0060c10  // mova { z16.d-z19.d }, za.d[x8, #0]\n"
    "add x8, x8, #0x1\n"
    ".inst 0xc0040d82  // mova za.d[x8, #2], { z12.d-z15.d }\n"
    ".inst 0xc168cb90  // fclamp { z16.h-z19.h }, z28.h, z8.h\n"
