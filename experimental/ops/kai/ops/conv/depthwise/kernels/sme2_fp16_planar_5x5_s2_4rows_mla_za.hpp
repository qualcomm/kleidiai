...
void sme2_fp16_planar_5x5_s2_4rows_mla_za_impl(
  const __fp16 *inptr,
  size_t ld_in_row,
  size_t ld_in_col,
  size_t ld_in_vl,
...
class sme2_fp16_planar_5x5_s2_4rows_mla_za : public PlanarStrategy<__fp16, __fp16>
{
  ...
  sme2_fp16_planar_5x5_s2_4rows_mla_za(const CPUInfo *)
  ...
  {
    return sme2_fp16_planar_5x5_s2_4rows_mla_za_impl;
  }
};
