...
)
{
  __asm__ __volatile__(
    ...
    "ext v10.16b, v10.16b, v10.16b, #0x4\n"
    ...
    "mov v29.16b, v4.16b\n"
    "ext v30.16b, v30.16b, v30.16b, #0x6\n"
    "zip1 v1.4s, v1.4s, v22.4s\n"
    "mov v22.16b, v4.16b\n"
    "ext v29.16b, v29.16b, v29.16b, #0x2\n"
    "ext v22.16b, v22.16b, v22.16b, #0x4\n"
    "zip1 v27.4s, v27.4s, v30.4s\n"
    "mov v30.16b, v4.16b\n"
    ".inst 0x6f81e250  // udot v16.4s, v18.16b, v1.4b[0]\n"
    ".inst 0x6fa1e259  // udot v25.4s, v18.16b, v1.4b[1]\n"
    ".inst 0x6f81ea5c  // udot v28.4s, v18.16b, v1.4b[2]\n"
    "ext v30.16b, v30.16b, v30.16b, #0x6\n"
    "zip1 v4.4s, v4.4s, v22.4s\n"
    "mov v22.16b, v0.16b\n"
    ".inst 0x6fa1ea4f  // udot v15.4s, v18.16b, v1.4b[3]\n"
    "zip1 v2.4s, v2.4s, v27.4s\n"
    "mov v27.16b, v0.16b\n"
    "ext v22.16b, v22.16b, v22.16b, #0x2\n"
    "zip1 v29.4s, v29.4s, v30.4s\n"
    "mov v30.16b, v0.16b\n"
    "ext v27.16b, v27.16b, v27.16b, #0x4\n"
    ".inst 0x6f82e257  // udot v23.4s, v18.16b, v2.4b[0]\n"
    ".inst 0x6fa2e24c  // udot v12.4s, v18.16b, v2.4b[1]\n"
    ".inst 0x6f82ea58  // udot v24.4s, v18.16b, v2.4b[2]\n"
    "ext v30.16b, v30.16b, v30.16b, #0x6\n"
    "zip1 v4.4s, v4.4s, v29.4s\n"
    "mov v29.16b, v3.16b\n"
    ".inst 0x6fa2ea4d  // udot v13.4s, v18.16b, v2.4b[3]\n"
    ...
    "mov v30.16b, v3.16b\n"
    "ext v27.16b, v27.16b, v27.16b, #0x4\n"
    ".inst 0x6f84e25f  // udot v31.4s, v18.16b, v4.4b[0]\n"
    ".inst 0x6fa4e24b  // udot v11.4s, v18.16b, v4.4b[1]\n"
    ".inst 0x6f84ea54  // udot v20.4s, v18.16b, v4.4b[2]\n"
    "add v16.4s, v16.4s, v23.4s\n"
    "ext v30.16b, v30.16b, v30.16b, #0x6\n"
    "zip1 v0.4s, v0.4s, v22.4s\n"
    ".inst 0x6fa4ea51  // udot v17.4s, v18.16b, v4.4b[3]\n"
    "zip1 v3.4s, v3.4s, v27.4s\n"
    "movi v27.4s, #0\n"
    "movi v22.4s, #0\n"
    "add v25.4s, v25.4s, v12.4s\n"
    "zip1 v29.4s, v29.4s, v30.4s\n"
    "movi v30.4s, #0\n"
    ".inst 0x6f80e255  // udot v21.4s, v18.16b, v0.4b[0]\n"
    ".inst 0x6fa0e25a  // udot v26.4s, v18.16b, v0.4b[1]\n"
    ".inst 0x6f80ea5b  // udot v27.4s, v18.16b, v0.4b[2]\n"
    "add v28.4s, v28.4s, v24.4s\n"
    ".inst 0x6fa0ea56  // udot v22.4s, v18.16b, v0.4b[3]\n"
    "add v15.4s, v15.4s, v13.4s\n"
    "zip1 v3.4s, v3.4s, v29.4s\n"
    "movi v29.4s, #0\n"
    "add v23.4s, v31.4s, v23.4s\n"
    "movi v31.4s, #0\n"
    "add v12.4s, v11.4s, v12.4s\n"
    "movi v11.4s, #0\n"
    ".inst 0x6f83e25e  // udot v30.4s, v18.16b, v3.4b[0]\n"
    ".inst 0x6fa3e25d  // udot v29.4s, v18.16b, v3.4b[1]\n"
    ".inst 0x6f83ea5f  // udot v31.4s, v18.16b, v3.4b[2]\n"
    "add v20.4s, v20.4s, v24.4s\n"
    ".inst 0x6fa3ea4b  // udot v11.4s, v18.16b, v3.4b[3]\n"
    "add v13.4s, v17.4s, v13.4s\n"
    "add v24.4s, v16.4s, v21.4s\n"
    "add v25.4s, v25.4s, v26.4s\n"
    "add v26.4s, v28.4s, v27.4s\n"
    "add v27.4s, v15.4s, v22.4s\n"
    "add v28.4s, v23.4s, v30.4s\n"
    "add v29.4s, v12.4s, v29.4s\n"
    "add v30.4s, v20.4s, v31.4s\n"
    "add v31.4s, v13.4s, v11.4s\n"
    ...
    "smax v24.4s, v24.4s, v9.4s\n"
    "smax v25.4s, v25.4s, v9.4s\n"
    "smax v26.4s, v26.4s, v9.4s\n"
    "smax v27.4s, v27.4s, v9.4s\n"
    "smax v28.4s, v28.4s, v9.4s\n"
    "smax v29.4s, v29.4s, v9.4s\n"
    "smax v30.4s, v30.4s, v9.4s\n"
    "smax v31.4s, v31.4s, v9.4s\n"
    ...
    "sqdmulh v25.4s, v25.4s, v17.4s\n"
    "sqdmulh v26.4s, v26.4s, v17.4s\n"
    "sqdmulh v27.4s, v27.4s, v17.4s\n"
    "sqdmulh v28.4s, v28.4s, v17.4s\n"
    "sqdmulh v29.4s, v29.4s, v17.4s\n"
    "srshl v24.4s, v24.4s, v16.4s\n"
    "sqdmulh v30.4s, v30.4s, v17.4s\n"
    "sqdmulh v31.4s, v31.4s, v17.4s\n"
