...
)
{
  ...
  __asm__ __volatile__(
    ...
    "incw x16\n"
    ".inst 0xc1adc9f0  // fclamp { z16.s-z19.s }, z15.s, z13.s\n"
    ...
    ".inst 0xc1adc9f4  // fclamp { z20.s-z23.s }, z15.s, z13.s\n"
    ...
    "ldr x22, [x14, #0x28]\n"
    ".inst 0xc1adc9f8  // fclamp { z24.s-z27.s }, z15.s, z13.s\n"
    "incw x15\n"
    ...
    "ldr x23, [x14, #0x40]\n"
    ".inst 0xc1adc9fc  // fclamp { z28.s-z31.s }, z15.s, z13.s\n"
    "addvl x8, x8, #1\n"
    ...
    ".inst 0xc1adc9f4  // fclamp { z20.s-z23.s }, z15.s, z13.s\n"
    "fmla z30.s, p3/M, z5.s, z10.s\n"
    "st1w { z16.s }, p0, [x12, x13, LSL #2]\n"
    "ldr x23, [x14, #0x20]\n"
    "fmla z31.s, p3/M, z4.s, z10.s\n"
    "st1w { z17.s }, p0, [x11, x13, LSL #2]\n"
    "ldr x22, [x14, #0x28]\n"
    ".inst 0xc1adc9f8  // fclamp { z24.s-z27.s }, z15.s, z13.s\n"
    "st1w { z18.s }, p0, [x10, x13, LSL #2]\n"
    "ldr x21, [x14, #0x30]\n"
    "st1w { z19.s }, p0, [x9, x13, LSL #2]\n"
    "ldr x20, [x14, #0x38]\n"
