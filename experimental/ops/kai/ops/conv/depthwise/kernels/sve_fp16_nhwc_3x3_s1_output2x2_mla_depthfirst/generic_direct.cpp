...
)
{
  ...
  __asm__ __volatile__(
    ...
    "st1h { z29.h }, p0, [x9, x13, LSL #1]\n"
    "addvl x9, x9, #1\n"
    "st1h { z30.h }, p0, [x23]\n"
    "st1h { z31.h }, p0, [x23, x13, LSL #1]\n"
    "addvl x23, x23, #1\n"
    "blt 2b\n"
    ...
    : "cc", "memory", "p0", "p1", "p2", "p3", "x9", "x10", "x11", "x12", "x13", "x14", "x15", "x16", "x17", "x20", "x21", "x22", "x23", "x24", "x25", "x26", "x27", "x28", "z0", "z1", "z2", "z3", "z4", "z5", "z6", "z7", "z8", "z9", "z10", "z11", "z12", "z13", "z16", "z17", "z18", "z28", "z29", "z30", "z31"
  );
}
