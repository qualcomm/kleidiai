...
)
{
  ...
  __asm__ __volatile__(
    ...
    "st1w { z25.s }, p1, [x22, x14, LSL #2]\n"
    "ldr x22, [x17, #0x68]\n"
    "ld1w { z5.s }, p3/Z, [x7, #6, MUL VL]\n"
    "st1w { z26.s }, p1, [x21, x14, LSL #2]\n"
    "ldr x21, [x17, #0x70]\n"
    "ld1w { z6.s }, p3/Z, [x7, #7, MUL VL]\n"
    "addvl x7, x7, #16\n"
    "st1w { z27.s }, p1, [x20, x14, LSL #2]\n"
    "ldr x20, [x17, #0x78]\n"
    ...
    "ld1w { z8.s }, p3/Z, [x7, #-7, MUL VL]\n"
    "addvl x7, x7, #-6\n"
    "st1w { z28.s }, p1, [x23, x14, LSL #2]\n"
    "st1w { z29.s }, p1, [x22, x14, LSL #2]\n"
    "st1w { z30.s }, p1, [x21, x14, LSL #2]\n"
    "st1w { z31.s }, p1, [x20, x14, LSL #2]\n"
    "blt 1b\n"
    "2:"  // Channel tail
    "movprfx z21, z15\n fmla z21.s, p3/M, z4.s, z9.s\n"
    "movprfx z16, z15\n fmla z16.s, p3/M, z8.s, z9.s\n"
    ...
    "ldr x23, [x17, #0x20]\n"
    "st1w { z17.s }, p0, [x11, x14, LSL #2]\n"
    "ldr x22, [x17, #0x28]\n"
    "fmin z21.s, p3/M, z21.s, z13.s\n"
    "fmax z24.s, p3/M, z24.s, z14.s\n"
    "st1w { z18.s }, p0, [x10, x14, LSL #2]\n"
    "ldr x21, [x17, #0x30]\n"
    "fmin z22.s, p3/M, z22.s, z13.s\n"
    "fmax z25.s, p3/M, z25.s, z14.s\n"
    "st1w { z19.s }, p0, [x9, x14, LSL #2]\n"
    "ldr x20, [x17, #0x38]\n"
    "fmin z23.s, p3/M, z23.s, z13.s\n"
    "fmax z26.s, p3/M, z26.s, z14.s\n"
    "fmax z27.s, p3/M, z27.s, z14.s\n"
    "st1w { z20.s }, p0, [x23, x14, LSL #2]\n"
    "ldr x23, [x17, #0x40]\n"
    "fmin z24.s, p3/M, z24.s, z13.s\n"
    ...
    "ldr x23, [x17, #0x60]\n"
    "fmin z28.s, p3/M, z28.s, z13.s\n"
    "st1w { z25.s }, p0, [x22, x14, LSL #2]\n"
    "ldr x22, [x17, #0x68]\n"
    "fmin z29.s, p3/M, z29.s, z13.s\n"
    "st1w { z26.s }, p0, [x21, x14, LSL #2]\n"
    "ldr x21, [x17, #0x70]\n"
    "fmin z30.s, p3/M, z30.s, z13.s\n"
    "st1w { z27.s }, p0, [x20, x14, LSL #2]\n"
    "ldr x20, [x17, #0x78]\n"
    "fmin z31.s, p3/M, z31.s, z13.s\n"
    "st1w { z28.s }, p0, [x23, x14, LSL #2]\n"
    "st1w { z29.s }, p0, [x22, x14, LSL #2]\n"
    "st1w { z30.s }, p0, [x21, x14, LSL #2]\n"
    "st1w { z31.s }, p0, [x20, x14, LSL #2]\n"
    :
