...
)
{
  ...
  __asm__ __volatile__(
    ...
    "ld1w { z11.s }, p2/Z, [x27, x16, LSL #2]\n"
    "fmla z17.s, p3/M, z2.s, z12.s\n"
    "fmla z18.s, p3/M, z1.s, z12.s\n"
    "ld1w { z12.s }, p2/Z, [x9, x11, LSL #2]\n"
    "addvl x9, x9, #1\n"
    ...
    "st1w { z18.s }, p0, [x17, x15, LSL #2]\n"
    "fmin z27.s, p3/M, z27.s, z14.s\n"
    "fmin z28.s, p3/M, z28.s, z14.s\n"
    "st1w { z19.s }, p0, [x17, x13, LSL #2]\n"
    "fmin z29.s, p3/M, z29.s, z14.s\n"
    "fmin z30.s, p3/M, z30.s, z14.s\n"
    "st1w { z20.s }, p0, [x25]\n"
    "fmin z31.s, p3/M, z31.s, z14.s\n"
    "addvl x27, x27, #1\n"
    "st1w { z21.s }, p0, [x25, x5, LSL #2]\n"
    "st1w { z22.s }, p0, [x25, x15, LSL #2]\n"
    "addvl x17, x17, #1\n"
    "addvl x8, x8, #-6\n"
    "st1w { z23.s }, p0, [x25, x13, LSL #2]\n"
    "addvl x25, x25, #1\n"
    "st1w { z24.s }, p0, [x24]\n"
    "st1w { z25.s }, p0, [x24, x5, LSL #2]\n"
    "st1w { z26.s }, p0, [x24, x15, LSL #2]\n"
    "st1w { z27.s }, p0, [x24, x13, LSL #2]\n"
    "addvl x24, x24, #1\n"
    "st1w { z28.s }, p0, [x23]\n"
    "st1w { z29.s }, p0, [x23, x5, LSL #2]\n"
    "st1w { z30.s }, p0, [x23, x15, LSL #2]\n"
