...
)
{
  ...
  __asm__ __volatile__(
    ...
    ".inst 0xc1b0ca58  // fclamp { z24.s-z27.s }, z18.s, z16.s\n"
    ...
    "addvl x17, x17, #4\n"
    "cmp x14, %x[n_channels]\n"
    ".inst 0xc1b0ca5c  // fclamp { z28.s-z31.s }, z18.s, z16.s\n"
    "ld1w { z8.s }, p3/Z, [x17]\n"
    "addvl x17, x17, #1\n"
    "st1w { z24.s }, p1, [x28, x12, LSL #2]\n"
    "ldr x23, [x13, #0x28]\n"
    "st1w { z23.s }, p1, [x9, x12, LSL #2]\n"
    "ldr x20, [x13, #0x20]\n"
    ...
    "ldr x20, [x13, #0x40]\n"
    "st1w { z28.s }, p1, [x23, x12, LSL #2]\n"
    "st1w { z29.s }, p1, [x22, x12, LSL #2]\n"
    "st1w { z30.s }, p1, [x21, x12, LSL #2]\n"
    "st1w { z31.s }, p1, [x20, x12, LSL #2]\n"
    "blt 1b\n"
    "2:"  // Channel tail
    "movprfx z23, z17\n fmla z23.s, p3/M, z8.s, z9.s\n"
    "movprfx z24, z17\n fmla z24.s, p3/M, z7.s, z9.s\n"
