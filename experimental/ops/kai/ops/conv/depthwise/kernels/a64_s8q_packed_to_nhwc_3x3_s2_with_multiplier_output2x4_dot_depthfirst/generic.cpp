...
)
{
  __asm__ __volatile__(
    ...
    "mov v30.16b, v4.16b\n"
    ".inst 0x4f81e250  // sdot v16.4s, v18.16b, v1.4b[0]\n"
    ".inst 0x4fa1e259  // sdot v25.4s, v18.16b, v1.4b[1]\n"
    ".inst 0x4f81ea5c  // sdot v28.4s, v18.16b, v1.4b[2]\n"
    "ext v30.16b, v30.16b, v30.16b, #0x6\n"
    "zip1 v4.4s, v4.4s, v22.4s\n"
    "mov v22.16b, v0.16b\n"
    ".inst 0x4fa1ea4f  // sdot v15.4s, v18.16b, v1.4b[3]\n"
    ...
    ".inst 0x4f82e257  // sdot v23.4s, v18.16b, v2.4b[0]\n"
    ".inst 0x4fa2e24c  // sdot v12.4s, v18.16b, v2.4b[1]\n"
    ".inst 0x4f82ea58  // sdot v24.4s, v18.16b, v2.4b[2]\n"
    "ext v30.16b, v30.16b, v30.16b, #0x6\n"
    "zip1 v4.4s, v4.4s, v29.4s\n"
    "mov v29.16b, v3.16b\n"
    ".inst 0x4fa2ea4d  // sdot v13.4s, v18.16b, v2.4b[3]\n"
    ...
    "mov v30.16b, v3.16b\n"
    "ext v27.16b, v27.16b, v27.16b, #0x4\n"
    ".inst 0x4f84e25f  // sdot v31.4s, v18.16b, v4.4b[0]\n"
    ".inst 0x4fa4e24b  // sdot v11.4s, v18.16b, v4.4b[1]\n"
    ...
    "zip1 v29.4s, v29.4s, v30.4s\n"
    "movi v30.4s, #0\n"
    ".inst 0x4f80e255  // sdot v21.4s, v18.16b, v0.4b[0]\n"
    ".inst 0x4fa0e25a  // sdot v26.4s, v18.16b, v0.4b[1]\n"
    ".inst 0x4f80ea5b  // sdot v27.4s, v18.16b, v0.4b[2]\n"
    "add v28.4s, v28.4s, v24.4s\n"
    ".inst 0x4fa0ea56  // sdot v22.4s, v18.16b, v0.4b[3]\n"
    ...
    "movi v11.4s, #0\n"
    ".inst 0x4f83e25e  // sdot v30.4s, v18.16b, v3.4b[0]\n"
    ".inst 0x4fa3e25d  // sdot v29.4s, v18.16b, v3.4b[1]\n"
    ".inst 0x4f83ea5f  // sdot v31.4s, v18.16b, v3.4b[2]\n"
    "add v20.4s, v20.4s, v24.4s\n"
    ".inst 0x4fa3ea4b  // sdot v11.4s, v18.16b, v3.4b[3]\n"
