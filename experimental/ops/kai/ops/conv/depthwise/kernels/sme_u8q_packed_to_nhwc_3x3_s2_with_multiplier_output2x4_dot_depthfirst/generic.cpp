...
void sme_u8q_packed_to_nhwc_3x3_s2_with_multiplier_output2x4_dot_depthfirst_impl(
...
)
{
  __asm__ __volatile__(
    ...
    "udot z8.s, z6.b, z1.b[1]\n"
    "udot z12.s, z6.b, z1.b[2]\n"
    "mov z3.q, z3.q[0]\n"
    "udot z23.s, z6.b, z1.b[3]\n"
    "udot z7.s, z6.b, z2.b[0]\n"
    "udot z14.s, z6.b, z2.b[1]\n"
    "udot z15.s, z6.b, z2.b[2]\n"
    "udot z16.s, z6.b, z2.b[3]\n"
    "udot z29.s, z6.b, z4.b[0]\n"
    "udot z26.s, z6.b, z4.b[1]\n"
    "udot z24.s, z6.b, z4.b[2]\n"
    "udot z25.s, z6.b, z4.b[3]\n"
    "udot z30.s, z6.b, z0.b[0]\n"
    "udot z9.s, z6.b, z0.b[1]\n"
    "udot z27.s, z6.b, z0.b[2]\n"
    "udot z28.s, z6.b, z0.b[3]\n"
    "udot z10.s, z6.b, z3.b[0]\n"
    "udot z13.s, z6.b, z3.b[1]\n"
    "udot z11.s, z6.b, z3.b[2]\n"
