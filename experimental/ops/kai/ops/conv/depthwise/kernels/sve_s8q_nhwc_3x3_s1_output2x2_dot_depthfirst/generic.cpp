...
void sve_s8q_nhwc_3x3_s1_output2x2_dot_depthfirst_impl(const unsigned int n_channels, const int8_t *const *const inptrs, const int8_t *params, const int32_t *, const kai::ops::Requantize32& qp, const int32_t *, const int32_t *, int8_t *const *const outptrs)
{
