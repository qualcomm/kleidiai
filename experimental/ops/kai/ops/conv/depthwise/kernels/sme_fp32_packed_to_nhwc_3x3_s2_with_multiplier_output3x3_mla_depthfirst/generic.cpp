...
void sme_fp32_packed_to_nhwc_3x3_s2_with_multiplier_output3x3_mla_depthfirst_impl(
...
)
{
  ...
  __asm__ __volatile__(
    ...
    "ld1rqw { z7.s }, p1/Z, [x21, #16]\n"
    "mov z19.d, z26.d\n"
    "mov z18.d, z26.d\n"
    "ldp x24, x23, [%x[outptrs], #0x20]\n"
    "ld1rqw { z8.s }, p1/Z, [x20]\n"
    "ldp x22, x21, [%x[outptrs], #0x30]\n"
    "ld1rqw { z9.s }, p1/Z, [x20, #16]\n"
