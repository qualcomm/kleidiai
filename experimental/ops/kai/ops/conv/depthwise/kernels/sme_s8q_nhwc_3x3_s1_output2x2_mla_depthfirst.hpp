...
void sme_s8q_nhwc_3x3_s1_output2x2_mla_depthfirst_impl(unsigned int, const int8_t *const *, const int8_t *, const int32_t *, const kai::ops::Requantize32 &, const int32_t *, const int32_t *, int8_t *const *);

class sme_s8q_nhwc_3x3_s1_output2x2_mla_depthfirst : public DepthwiseDepthfirstStrategy<int8_t, int8_t, int8_t, int32_t>
{
  ...
  sme_s8q_nhwc_3x3_s1_output2x2_mla_depthfirst(const CPUInfo *) : Parent(2, 2, 3, 3, 1, 1) {}

  kai::ops::VLType get_vl_type(void) const override { return kai::ops::VLType::SME; }

  Parent::KernelType kernel = sme_s8q_nhwc_3x3_s1_output2x2_mla_depthfirst_impl;
