...
)
{
  ...
  __asm__ __volatile__(
    ...
    "st1h { z24.h }, p0, [x13, x17, LSL #1]\n"
    "st1h { z25.h }, p0, [x13, x10, LSL #1]\n"
    "addvl x13, x13, #1\n"
    "addvl x14, x14, #-6\n"
    "st1h { z26.h }, p0, [x24]\n"
    "st1h { z27.h }, p0, [x24, x17, LSL #1]\n"
    "st1h { z28.h }, p0, [x24, x10, LSL #1]\n"
    "addvl x24, x24, #1\n"
    "st1h { z29.h }, p0, [x23]\n"
    "st1h { z30.h }, p0, [x23, x17, LSL #1]\n"
    "st1h { z31.h }, p0, [x23, x10, LSL #1]\n"
    "addvl x23, x23, #1\n"
    "blt 2b\n"
