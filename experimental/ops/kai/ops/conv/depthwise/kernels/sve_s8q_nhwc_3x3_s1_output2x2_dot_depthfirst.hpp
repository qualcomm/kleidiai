...
void sve_s8q_nhwc_3x3_s1_output2x2_dot_depthfirst_impl(unsigned int, const int8_t *const *, const int8_t *, const int32_t *, const kai::ops::Requantize32&, const int32_t *, const int32_t *, int8_t *const *);
