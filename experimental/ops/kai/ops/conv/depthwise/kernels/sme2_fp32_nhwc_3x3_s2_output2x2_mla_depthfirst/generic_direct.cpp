...
)
{
  ...
  __asm__ __volatile__(
    ...
    "ld1w { z12.s }, p2/Z, [x16, x17, LSL #2]\n"
    "ld1w { z10.s }, p1/Z, [x5]\n"
    "fmla z28.s, p3/M, z1.s, z11.s\n"
    "fmla z29.s, p3/M, z2.s, z13.s\n"
    "ld1w { z11.s }, p2/Z, [x16, x8, LSL #2]\n"
    ...
    "ld1w { z12.s }, p2/Z, [x15, x8, LSL #2]\n"
    "ld1w { z16.s }, p2/Z, [x15, x4, LSL #2]\n"
    "fmla z30.s, p3/M, z4.s, z11.s\n"
    "ld1w { z11.s }, p2/Z, [x15, x17, LSL #2]\n"
    "addvl x15, x15, #1\n"
