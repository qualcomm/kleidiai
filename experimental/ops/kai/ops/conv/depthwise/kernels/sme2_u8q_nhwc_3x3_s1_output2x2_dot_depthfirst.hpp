...
void sme2_u8q_nhwc_3x3_s1_output2x2_dot_depthfirst_impl(unsigned int, const uint8_t *const *, const uint8_t *, const int32_t *, const kai::ops::Requantize32&, const int32_t *, const int32_t *, uint8_t *const *);

class sme2_u8q_nhwc_3x3_s1_output2x2_dot_depthfirst : public DepthwiseDepthfirstStrategy<uint8_t, uint8_t, uint8_t, int32_t>
{
  ...
  sme2_u8q_nhwc_3x3_s1_output2x2_dot_depthfirst(const CPUInfo *) : Parent(2, 2, 3, 3, 1, 1) {}

  kai::ops::VLType get_vl_type(void) const override { return kai::ops::VLType::SME; }

  Parent::KernelType kernel = sme2_u8q_nhwc_3x3_s1_output2x2_dot_depthfirst_impl;
  ...
  {
    return interleave_sme_u8q_3x3_dot::get_packed_size(args);
  }
  ...
  {
    interleave_sme_u8q_3x3_dot::pack_parameters(
