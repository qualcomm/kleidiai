...
)
{
  ...
  __asm__ __volatile__(
    ...
    "st1h { z25.h }, p1, [x22, x14, LSL #1]\n"
    "ldr x22, [x17, #0x68]\n"
    "ld1h { z5.h }, p3/Z, [x7, #6, MUL VL]\n"
    "st1h { z26.h }, p1, [x21, x14, LSL #1]\n"
    "ldr x21, [x17, #0x70]\n"
    "ld1h { z6.h }, p3/Z, [x7, #7, MUL VL]\n"
    "addvl x7, x7, #16\n"
    "st1h { z27.h }, p1, [x20, x14, LSL #1]\n"
    "ldr x20, [x17, #0x78]\n"
    ...
    "ld1h { z8.h }, p3/Z, [x7, #-7, MUL VL]\n"
    "addvl x7, x7, #-6\n"
    "st1h { z28.h }, p1, [x23, x14, LSL #1]\n"
    "st1h { z29.h }, p1, [x22, x14, LSL #1]\n"
    "st1h { z30.h }, p1, [x21, x14, LSL #1]\n"
    "st1h { z31.h }, p1, [x20, x14, LSL #1]\n"
    "blt 1b\n"
    "2:"  // Channel tail
    "movprfx z21, z15\n fmla z21.h, p3/M, z4.h, z9.h\n"
    "movprfx z16, z15\n fmla z16.h, p3/M, z8.h, z9.h\n"
    ...
    "ldr x23, [x17, #0x20]\n"
    "st1h { z17.h }, p0, [x11, x14, LSL #1]\n"
    "ldr x22, [x17, #0x28]\n"
    "fmin z21.h, p3/M, z21.h, z13.h\n"
    "fmax z24.h, p3/M, z24.h, z14.h\n"
    "st1h { z18.h }, p0, [x10, x14, LSL #1]\n"
    "ldr x21, [x17, #0x30]\n"
    "fmin z22.h, p3/M, z22.h, z13.h\n"
    "fmax z25.h, p3/M, z25.h, z14.h\n"
    "st1h { z19.h }, p0, [x9, x14, LSL #1]\n"
    "ldr x20, [x17, #0x38]\n"
    "fmin z23.h, p3/M, z23.h, z13.h\n"
    "fmax z26.h, p3/M, z26.h, z14.h\n"
    "fmax z27.h, p3/M, z27.h, z14.h\n"
    "st1h { z20.h }, p0, [x23, x14, LSL #1]\n"
    "ldr x23, [x17, #0x40]\n"
    "fmin z24.h, p3/M, z24.h, z13.h\n"
    ...
    "ldr x23, [x17, #0x60]\n"
    "fmin z28.h, p3/M, z28.h, z13.h\n"
    "st1h { z25.h }, p0, [x22, x14, LSL #1]\n"
    "ldr x22, [x17, #0x68]\n"
    "fmin z29.h, p3/M, z29.h, z13.h\n"
    "st1h { z26.h }, p0, [x21, x14, LSL #1]\n"
    "ldr x21, [x17, #0x70]\n"
    "fmin z30.h, p3/M, z30.h, z13.h\n"
    "st1h { z27.h }, p0, [x20, x14, LSL #1]\n"
    "ldr x20, [x17, #0x78]\n"
    "fmin z31.h, p3/M, z31.h, z13.h\n"
    "st1h { z28.h }, p0, [x23, x14, LSL #1]\n"
    "st1h { z29.h }, p0, [x22, x14, LSL #1]\n"
    "st1h { z30.h }, p0, [x21, x14, LSL #1]\n"
    "st1h { z31.h }, p0, [x20, x14, LSL #1]\n"
    :
