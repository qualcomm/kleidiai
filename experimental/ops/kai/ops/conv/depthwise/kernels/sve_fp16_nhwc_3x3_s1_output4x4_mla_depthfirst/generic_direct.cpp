...
)
{
  ...
  __asm__ __volatile__(
    ...
    "ld1h { z10.h }, p2/Z, [x7, x16, LSL #1]\n"
    "fmla z30.h, p3/M, z8.h, z11.h\n"
    "fmla z31.h, p3/M, z7.h, z11.h\n"
    "ld1h { z11.h }, p2/Z, [x28, x4, LSL #1]\n"
    ...
    "ld1h { z11.h }, p2/Z, [x27, x16, LSL #1]\n"
    "fmla z17.h, p3/M, z2.h, z12.h\n"
    "fmla z18.h, p3/M, z1.h, z12.h\n"
    "ld1h { z12.h }, p2/Z, [x9, x11, LSL #1]\n"
    "addvl x9, x9, #1\n"
    ...
    "st1h { z18.h }, p0, [x17, x15, LSL #1]\n"
    "fmin z27.h, p3/M, z27.h, z14.h\n"
    "fmin z28.h, p3/M, z28.h, z14.h\n"
    "st1h { z19.h }, p0, [x17, x13, LSL #1]\n"
    "fmin z29.h, p3/M, z29.h, z14.h\n"
    "fmin z30.h, p3/M, z30.h, z14.h\n"
    "st1h { z20.h }, p0, [x25]\n"
    "fmin z31.h, p3/M, z31.h, z14.h\n"
    "addvl x27, x27, #1\n"
    "st1h { z21.h }, p0, [x25, x5, LSL #1]\n"
    "st1h { z22.h }, p0, [x25, x15, LSL #1]\n"
    "addvl x17, x17, #1\n"
    "addvl x8, x8, #-6\n"
    "st1h { z23.h }, p0, [x25, x13, LSL #1]\n"
    "addvl x25, x25, #1\n"
    "st1h { z24.h }, p0, [x24]\n"
    "st1h { z25.h }, p0, [x24, x5, LSL #1]\n"
    "st1h { z26.h }, p0, [x24, x15, LSL #1]\n"
    "st1h { z27.h }, p0, [x24, x13, LSL #1]\n"
    "addvl x24, x24, #1\n"
    "st1h { z28.h }, p0, [x23]\n"
    "st1h { z29.h }, p0, [x23, x5, LSL #1]\n"
    "st1h { z30.h }, p0, [x23, x15, LSL #1]\n"
