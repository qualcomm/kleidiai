...
void sme_u8q_nhwc_3x3_s2_output2x2_mla_depthfirst_impl(
...
)
{
  ...
  __asm__ __volatile__(
    ...
    "ld1b { z29.h }, p4/Z, [x16]\n"
    "ld1b { z15.h }, p4/Z, [x16, #1, MUL VL]\n"
    "ld1b { z18.h }, p4/Z, [x16, #2, MUL VL]\n"
    "ld1b { z5.h }, p4/Z, [x16, #3, MUL VL]\n"
    ".inst 0x454b1bbd  // usublb z29.h, z29.b, z11.b\n"
    "ld1b { z12.h }, p4/Z, [x16, #4, MUL VL]\n"
    ".inst 0x454b19ef  // usublb z15.h, z15.b, z11.b\n"
    "ld1b { z9.h }, p4/Z, [x16, #5, MUL VL]\n"
    ".inst 0x454b1a52  // usublb z18.h, z18.b, z11.b\n"
    "ld1b { z3.h }, p4/Z, [x16, #6, MUL VL]\n"
    ".inst 0x454b18a5  // usublb z5.h, z5.b, z11.b\n"
    "ld1b { z19.h }, p4/Z, [x16, #7, MUL VL]\n"
    "inch x16, ALL, MUL #8\n"
    ".inst 0x454b198c  // usublb z12.h, z12.b, z11.b\n"
    "ld1w { z22.s }, p2/Z, [x21]\n"
    ".inst 0x454b1929  // usublb z9.h, z9.b, z11.b\n"
    "ld1w { z31.s }, p1/Z, [x21, #1, MUL VL]\n"
    "addvl x21, x21, #2\n"
    ".inst 0x454b1863  // usublb z3.h, z3.b, z11.b\n"
    "ld1b { z26.h }, p4/Z, [x16]\n"
    "ldp x27, x26, [x7, #0]\n"
    "str x21, [%x[params], %[offsetof_Params_bias]]\n"
    ".inst 0x454b1a73  // usublb z19.h, z19.b, z11.b\n"
    "uzp1 z4.s, z22.s, z31.s\n"
    "uzp2 z10.s, z22.s, z31.s\n"
    "ldp x25, x24, [x7, #0x10]\n"
    ".inst 0x454b1b5a  // usublb z26.h, z26.b, z11.b\n"
    "ldp x23, x22, [x7, #0x20]\n"
    "mov z1.d, z4.d\n"
    "mov z8.d, z10.d\n"
    "mov z16.d, z4.d\n"
    ...
    "ld1b { z25.h }, p3/Z, [x26, x6]\n"
    "ld1b { z22.h }, p3/Z, [x25, x6]\n"
    "ld1b { z27.h }, p3/Z, [x24, x6]\n"
    ".inst 0x454e1b9c  // usublb z28.h, z28.b, z14.b\n"
    "ld1b { z7.h }, p3/Z, [x23, x6]\n"
    ".inst 0x454e1b39  // usublb z25.h, z25.b, z14.b\n"
    "ld1b { z24.h }, p3/Z, [x22, x6]\n"
    ".inst 0x454e1ad6  // usublb z22.h, z22.b, z14.b\n"
    "ld1b { z6.h }, p3/Z, [x21, x6]\n"
    ".inst 0x454e1b7b  // usublb z27.h, z27.b, z14.b\n"
    "ld1b { z20.h }, p3/Z, [x20, x6]\n"
    ...
    "ld1b { z25.h }, p3/Z, [x21, x6]\n"
    "ldr x21, [x7, #0x70]\n"
    ".inst 0x448f4768  // smlalt z8.s, p4/M, z27.h, z15.h\n"
    "ld1b { z27.h }, p3/Z, [x25, x6]\n"
    "ldr x9, [x7, #0x98]\n"
    ...
    ".inst 0x454e198c  // usublb z12.h, z12.b, z14.b\n"
    ".inst 0x4492468a  // smlalt z10.s, p4/M, z20.h, z18.h\n"
    "ld1b { z20.h }, p3/Z, [x22, x6]\n"
    ".inst 0x448540de  // smlalb z30.s, p4/M, z6.h, z5.h\n"
    ".inst 0x454e19ef  // usublb z15.h, z15.b, z14.b\n"
    "ld1b { z18.h }, p3/Z, [x20, x6]\n"
    "inch x6\n"
