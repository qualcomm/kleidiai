...
void sme_u8q_nhwc_3x3_s1_output2x2_mla_depthfirst_impl(
...
)
{
  ...
  __asm__ __volatile__(
    ...
    "ld1b { z9.h }, p4/Z, [x11]\n"
    "ld1b { z22.h }, p4/Z, [x11, #1, MUL VL]\n"
    "ld1b { z11.h }, p4/Z, [x11, #2, MUL VL]\n"
    "ld1b { z16.h }, p4/Z, [x11, #3, MUL VL]\n"
    ".inst 0x454e1929  // usublb z9.h, z9.b, z14.b\n"
    "ld1b { z8.h }, p4/Z, [x11, #4, MUL VL]\n"
    ".inst 0x454e1ad6  // usublb z22.h, z22.b, z14.b\n"
    "ld1b { z2.h }, p4/Z, [x11, #5, MUL VL]\n"
    ".inst 0x454e196b  // usublb z11.h, z11.b, z14.b\n"
    "ld1b { z10.h }, p4/Z, [x11, #6, MUL VL]\n"
    ".inst 0x454e1a10  // usublb z16.h, z16.b, z14.b\n"
    "ld1b { z28.h }, p4/Z, [x11, #7, MUL VL]\n"
    "inch x11, ALL, MUL #8\n"
    ".inst 0x454e1908  // usublb z8.h, z8.b, z14.b\n"
    "ld1w { z31.s }, p2/Z, [x21]\n"
    ".inst 0x454e1842  // usublb z2.h, z2.b, z14.b\n"
    "ld1w { z20.s }, p1/Z, [x21, #1, MUL VL]\n"
    "addvl x21, x21, #2\n"
    ".inst 0x454e194a  // usublb z10.h, z10.b, z14.b\n"
    "ld1b { z6.h }, p4/Z, [x11]\n"
    "ldp x24, x23, [x15, #0]\n"
    ...
    "ldr x20, [x15, #0x20]\n"
    "ld1b { z4.h }, p3/Z, [x24, x16]\n"
    "mov z7.d, z0.d\n"
    "mov z19.d, z5.d\n"
    "ld1b { z26.h }, p3/Z, [x23, x16]\n"
    "mov z20.d, z0.d\n"
    "mov z3.d, z5.d\n"
    "ld1b { z27.h }, p3/Z, [x22, x16]\n"
    "mov z24.d, z0.d\n"
    "mov z29.d, z5.d\n"
    "ld1b { z23.h }, p3/Z, [x21, x16]\n"
