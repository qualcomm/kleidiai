...
)
{
  ...
  __asm__ __volatile__(
    ...
    "st1h { z16.h }, p0, [x28]\n"
    "st1h { z17.h }, p0, [x28, x9, LSL #1]\n"
    "st1h { z18.h }, p0, [x28, x27, LSL #1]\n"
    "st1h { z19.h }, p0, [x28, x26, LSL #1]\n"
    "addvl x28, x28, #1\n"
    "st1h { z20.h }, p0, [x25]\n"
    ...
    "addvl x25, x25, #1\n"
    "st1h { z24.h }, p0, [x24]\n"
    "st1h { z25.h }, p0, [x24, x9, LSL #1]\n"
    "st1h { z26.h }, p0, [x24, x27, LSL #1]\n"
    "st1h { z27.h }, p0, [x24, x26, LSL #1]\n"
    "addvl x24, x24, #1\n"
    "st1h { z28.h }, p0, [x23]\n"
    "st1h { z29.h }, p0, [x23, x9, LSL #1]\n"
