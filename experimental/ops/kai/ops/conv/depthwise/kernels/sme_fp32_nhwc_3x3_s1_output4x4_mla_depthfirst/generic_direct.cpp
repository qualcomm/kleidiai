...
)
{
  ...
  __asm__ __volatile__(
    ...
    "addvl x20, x20, #-6\n"
    "ld1w { z9.s }, p2/Z, [x13, x17, LSL #2]\n"
    "ld1w { z11.s }, p2/Z, [x7, x28, LSL #2]\n"
    ...
    "ld1w { z11.s }, p1/Z, [x7, x28, LSL #2]\n"
    "fmax z23.s, p3/M, z23.s, z15.s\n"
    "fmax z24.s, p3/M, z24.s, z15.s\n"
    "ld1w { z12.s }, p1/Z, [x13, x15, LSL #2]\n"
    ...
    "st1w { z17.s }, p0, [x16, x8, LSL #2]\n"
    "fmin z27.s, p3/M, z27.s, z14.s\n"
    "fmin z28.s, p3/M, z28.s, z14.s\n"
    "st1w { z18.s }, p0, [x16, x26, LSL #2]\n"
    "fmin z29.s, p3/M, z29.s, z14.s\n"
    "fmin z30.s, p3/M, z30.s, z14.s\n"
    "st1w { z19.s }, p0, [x16, x23, LSL #2]\n"
    "addvl x16, x16, #1\n"
    "fmin z31.s, p3/M, z31.s, z14.s\n"
    "st1w { z20.s }, p0, [x10]\n"
    "st1w { z21.s }, p0, [x10, x8, LSL #2]\n"
    "st1w { z22.s }, p0, [x10, x26, LSL #2]\n"
    "st1w { z23.s }, p0, [x10, x23, LSL #2]\n"
    "addvl x10, x10, #1\n"
    "st1w { z24.s }, p0, [x27]\n"
    "st1w { z25.s }, p0, [x27, x8, LSL #2]\n"
    "st1w { z26.s }, p0, [x27, x26, LSL #2]\n"
    "st1w { z27.s }, p0, [x27, x23, LSL #2]\n"
    "addvl x27, x27, #1\n"
    "st1w { z28.s }, p0, [x24]\n"
    "st1w { z29.s }, p0, [x24, x8, LSL #2]\n"
    "st1w { z30.s }, p0, [x24, x26, LSL #2]\n"
    "st1w { z31.s }, p0, [x24, x23, LSL #2]\n"
    "addvl x24, x24, #1\n"
    "blt 2b\n"
