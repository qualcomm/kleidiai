...
)
{
  ...
  __asm__ __volatile__(
    ...
    "ld1h { z11.h }, p2/Z, [x20, x14, LSL #1]\n"
    "fmla z28.h, p3/M, z5.h, z13.h\n"
    "fmla z29.h, p3/M, z3.h, z13.h\n"
    "ld1h { z13.h }, p2/Z, [x27, x14, LSL #1]\n"
    "ldr x20, [x16, #0xb8]\n"
    ...
    "ldr x20, [x16, #0x80]\n"
    "fmla z29.h, p3/M, z2.h, z13.h\n"
    "ld1h { z13.h }, p2/Z, [x26, x14, LSL #1]\n"
    "ldr x26, [x16, #0x90]\n"
    "fmla z28.h, p3/M, z3.h, z14.h\n"
    "ld1h { z14.h }, p2/Z, [x25, x14, LSL #1]\n"
    "ldr x25, [x16, #0x98]\n"
    "fmla z29.h, p3/M, z0.h, z16.h\n"
    "fmla z28.h, p3/M, z4.h, z15.h\n"
    "ld1h { z15.h }, p2/Z, [x24, x14, LSL #1]\n"
