...
void sme_u8q_nhwc_5x5_s1_output2x2_mla_depthfirst_impl(unsigned int, const uint8_t *const *, const uint8_t *, const int32_t *, const kai::ops::Requantize32 &, const int32_t *, const int32_t *, uint8_t *const *);

class sme_u8q_nhwc_5x5_s1_output2x2_mla_depthfirst : public DepthwiseDepthfirstStrategy<uint8_t, uint8_t, uint8_t, int32_t>
{
  ...
  sme_u8q_nhwc_5x5_s1_output2x2_mla_depthfirst(const CPUInfo *) : Parent(2, 2, 5, 5, 1, 1) {}

  kai::ops::VLType get_vl_type(void) const override { return kai::ops::VLType::SME; }

  Parent::KernelType kernel = sme_u8q_nhwc_5x5_s1_output2x2_mla_depthfirst_impl;
