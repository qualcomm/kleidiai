...
)
{
  ...
  __asm__ __volatile__(
    ...
    "sub x11, x11, x21\n"
    ".inst 0xc169c87c  // fclamp { z28.h-z31.h }, z3.h, z9.h\n"
    "4:"  // Left padding
    "subs x21, x21, #0x1\n"
    "st1h { z28.h }, p1, [x9]\n"
    "add x9, x9, x27, LSL #1\n"
    ...
    "add x20, x20, %x[ld_in_row], LSL #1\n"
    "ld1h { z27.h }, p1/Z, [x20]\n"
    ".inst 0xc13e1ec0  // fmla za.h[x8, 0], { z22.h-z25.h }, z14.h\n"
    ".inst 0xc13c1ee0  // fmla za.h[x8, 0], { z23.h-z26.h }, z12.h\n"
    ...
    "add x20, x20, %x[ld_in_row], LSL #1\n"
    "ld1h { z29.h }, p1/Z, [x20]\n"
    ".inst 0xc13f1f00  // fmla za.h[x8, 0], { z24.h-z27.h }, z15.h\n"
    ".inst 0xc13e1f01  // fmla za.h[x8, 1], { z24.h-z27.h }, z14.h\n"
    ".inst 0xc13d1f20  // fmla za.h[x8, 0], { z25.h-z28.h }, z13.h\n"
    ".inst 0xc13c1f21  // fmla za.h[x8, 1], { z25.h-z28.h }, z12.h\n"
    ".inst 0xc1351f40  // fmla za.h[x8, 0], { z26.h-z29.h }, z5.h\n"
    ".inst 0xc1341f41  // fmla za.h[x8, 1], { z26.h-z29.h }, z4.h\n"
    ...
    ".inst 0xc13b1e80  // fmla za.h[x8, 0], { z20.h-z23.h }, z11.h\n"
    "add x20, x13, %x[ld_in_row], LSL #1\n"
    "subs x21, x21, #0x1\n"
    ".inst 0xc13f1e81  // fmla za.h[x8, 1], { z20.h-z23.h }, z15.h\n"
    ".inst 0xc13e1e82  // fmla za.h[x8, 2], { z20.h-z23.h }, z14.h\n"
    "ld1h { z20.h }, p1/Z, [x13]\n"
    "add x13, x13, %x[ld_in_col], LSL #1\n"
    ".inst 0xc1301ea0  // fmla za.h[x8, 0], { z21.h-z24.h }, z0.h\n"
    ".inst 0xc13d1ea1  // fmla za.h[x8, 1], { z21.h-z24.h }, z13.h\n"
    ".inst 0xc13c1ea2  // fmla za.h[x8, 2], { z21.h-z24.h }, z12.h\n"
    "ld1h { z21.h }, p1/Z, [x20]\n"
    "add x20, x20, %x[ld_in_row], LSL #1\n"
    ".inst 0xc1371ec0  // fmla za.h[x8, 0], { z22.h-z25.h }, z7.h\n"
    ".inst 0xc1351ec1  // fmla za.h[x8, 1], { z22.h-z25.h }, z5.h\n"
    ".inst 0xc1341ec2  // fmla za.h[x8, 2], { z22.h-z25.h }, z4.h\n"
    "ld1h { z22.h }, p1/Z, [x20]\n"
    "add x20, x20, %x[ld_in_row], LSL #1\n"
    "ld1h { z23.h }, p1/Z, [x20]\n"
    "add x20, x20, %x[ld_in_row], LSL #1\n"
    ...
    "add x20, x20, %x[ld_in_row], LSL #1\n"
    ".inst 0xc13e1ee0  // fmla za.h[x8, 0], { z23.h-z26.h }, z14.h\n"
    "ld1h { z27.h }, p0/Z, [x20]\n"
    ".inst 0x256c4500  // psel p0.b, p1.b/Z, p8.b[w12, #5]\n"
    "add x20, x20, %x[ld_in_row], LSL #1\n"
    "ld1h { z28.h }, p0/Z, [x20]\n"
    ".inst 0xc13c1f00  // fmla za.h[x8, 0], { z24.h-z27.h }, z12.h\n"
    ".inst 0xc1341f20  // fmla za.h[x8, 0], { z25.h-z28.h }, z4.h\n"
    ...
    ".inst 0x25644500  // psel p0.b, p1.b/Z, p8.b[w12, #4]\n"
    "add x20, x20, %x[ld_in_row], LSL #1\n"
    ".inst 0xc13f1f20  // fmla za.h[x8, 0], { z25.h-z28.h }, z15.h\n"
    "ld1h { z29.h }, p0/Z, [x20]\n"
    ".inst 0x256c4500  // psel p0.b, p1.b/Z, p8.b[w12, #5]\n"
    "add x20, x20, %x[ld_in_row], LSL #1\n"
    ".inst 0xc13e1f21  // fmla za.h[x8, 1], { z25.h-z28.h }, z14.h\n"
    "ld1h { z30.h }, p0/Z, [x20]\n"
    ".inst 0xc13d1f40  // fmla za.h[x8, 0], { z26.h-z29.h }, z13.h\n"
    ".inst 0xc13c1f41  // fmla za.h[x8, 1], { z26.h-z29.h }, z12.h\n"
    ...
    "add x8, x8, #0x1\n"
    ".inst 0xc0040e02  // mova za.d[x8, #2], { z16.d-z19.d }\n"
    ".inst 0xc169c874  // fclamp { z20.h-z23.h }, z3.h, z9.h\n"
    "st1h { z20.h }, p1, [x9]\n"
    "add x9, x9, x27, LSL #1\n"
    "st1h { z21.h }, p1, [x28]\n"
    "add x28, x28, x26, LSL #1\n"
    ...
    "subs x11, x11, #0x1\n"
    ".inst 0xc0040e02  // mova za.d[x8, #2], { z16.d-z19.d }\n"
    ".inst 0xc169c864  // fclamp { z4.h-z7.h }, z3.h, z9.h\n"
    "st1h { z4.h }, p1, [x9]\n"
    "add x9, x9, x27, LSL #1\n"
    "st1h { z5.h }, p1, [x28]\n"
    "add x28, x28, x26, LSL #1\n"
