...
size_t interleave_sve_s8q_3x3_dot::get_packed_size(const DepthwiseArgs &args)
{
  ...
  return n * 7 * get_vector_length<int8_t>(kai::ops::VLType::SVE);
}

void interleave_sve_s8q_3x3_dot::pack_parameters(unsigned int n_channels, void *outptr, const int32_t *bias, const int8_t *weights, const kai::ops::Requantize32 &qp, size_t ld_weight_col, size_t ld_weight_row)
{
