...
size_t interleave_sme2_u8q_3x3_dot::get_packed_size(const DepthwiseArgs &args)
{
  ...
  const unsigned int n = kai::ops::roundup(
    kai::ops::iceildiv((long unsigned int) args.input_channels * args.channel_multiplier,
                       get_vector_length<int32_t>(kai::ops::VLType::SME2)), 4lu
  );
  return n * 7 * get_vector_length<uint8_t>(kai::ops::VLType::SME2);
}

void interleave_sme2_u8q_3x3_dot::pack_parameters(unsigned int n_channels, void *outptr, const int32_t *bias, const uint8_t *weights, const kai::ops::Requantize32 &qp, size_t ld_weight_col, size_t ld_weight_row)
{
  __asm__ __volatile__(
    ...
    "udot z25.s, z29.b, z19.b\n"
    "zip1 z16.b, z16.b, z18.b\n"
    "udot z25.s, z29.b, z17.b\n"
    "udot z25.s, z29.b, z16.b\n"
