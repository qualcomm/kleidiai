//
// SPDX-FileCopyrightText: Copyright 2017-2021, 2023-2026 Arm Limited and/or its affiliates <open-source-office@arm.com>
//
...
namespace kai {
namespace ops {
// Avoid circular dependency with kai_ops.hpp
struct GemmConfig;
